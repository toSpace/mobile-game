...
class ApplicationMain {
	...
	public static function getAsset (inName:String):Dynamic {
		...
		if (inName=="assets/hill.png")
			 
            return Assets.getBitmapData ("assets/hill.png");
...
class NME_assets_hill_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
