class World1Level1 extends Level {
	...
	public override function loadLevel(){
		...
		//sterren (fixer?)
		//zon (fixex?)
		var lvl1_bg_l6_background = new BackgroundObject('world1/lvl1/bg/l6/lvl1_bg_l6_background.xml');
		var lvl1_bg_l6_sun = new BackgroundObject('world1/lvl1/bg/l6/lvl1_bg_l6_sun.xml');
