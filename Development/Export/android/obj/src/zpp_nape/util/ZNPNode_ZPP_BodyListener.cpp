...
{
HX_STACK_PUSH("ZNPNode_ZPP_BodyListener::new","zpp_nape/util/Lists.hx",15201);
{
	HX_STACK_LINE(15235)
	this->elt = null();
	HX_STACK_LINE(15226)
...
::zpp_nape::callbacks::ZPP_BodyListener ZNPNode_ZPP_BodyListener_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_BodyListener::elem","zpp_nape/util/Lists.hx",15239);
	HX_STACK_THIS(this);
	HX_STACK_LINE(15239)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_BodyListener::free","zpp_nape/util/Lists.hx",15232);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15232)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_BodyListener::alloc","zpp_nape/util/Lists.hx",15229);
		HX_STACK_THIS(this);
	}
return null();
}
