...
{
HX_STACK_PUSH("ZNPNode_ZPP_ToiEvent::new","zpp_nape/util/Lists.hx",16104);
{
	HX_STACK_LINE(16138)
	this->elt = null();
	HX_STACK_LINE(16129)
...
::zpp_nape::geom::ZPP_ToiEvent ZNPNode_ZPP_ToiEvent_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_ToiEvent::elem","zpp_nape/util/Lists.hx",16142);
	HX_STACK_THIS(this);
	HX_STACK_LINE(16142)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_ToiEvent::free","zpp_nape/util/Lists.hx",16135);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16135)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_ToiEvent::alloc","zpp_nape/util/Lists.hx",16132);
		HX_STACK_THIS(this);
	}
return null();
}
