...
{
HX_STACK_PUSH("ZNPNode_ZPP_PartitionVertex::new","zpp_nape/util/Lists.hx",15416);
{
	HX_STACK_LINE(15450)
	this->elt = null();
	HX_STACK_LINE(15441)
...
::zpp_nape::geom::ZPP_PartitionVertex ZNPNode_ZPP_PartitionVertex_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_PartitionVertex::elem","zpp_nape/util/Lists.hx",15454);
	HX_STACK_THIS(this);
	HX_STACK_LINE(15454)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_PartitionVertex::free","zpp_nape/util/Lists.hx",15447);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15447)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_PartitionVertex::alloc","zpp_nape/util/Lists.hx",15444);
		HX_STACK_THIS(this);
	}
return null();
}
