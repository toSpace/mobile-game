...
Void Assets_obj::initialize( ){
{
		...
		if ((!(::nme::installer::Assets_obj::initialized))){
			HX_STACK_LINE(43)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/mobile-1x/General/Enemies/empty.md"),HX_CSTRING("assets_mobile_1x_general_enemies_empty_md"));
			HX_STACK_LINE(44)
			...
			HX_STACK_LINE(99)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/source/bg.xml"),HX_CSTRING("assets_source_bg_xml"));
			HX_STACK_LINE(100)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/source/bg.xml"),HX_CSTRING("text"));
			HX_STACK_LINE(101)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/source/General/Enemies/empty.md"),HX_CSTRING("assets_source_general_enemies_empty_md"));
			HX_STACK_LINE(102)
			...
			HX_STACK_LINE(143)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/source/test.xml"),HX_CSTRING("assets_source_test_xml"));
			HX_STACK_LINE(144)
			::nme::installer::Assets_obj::resourceTypes->set(HX_CSTRING("assets/source/test.xml"),HX_CSTRING("text"));
			HX_STACK_LINE(145)
			::nme::installer::Assets_obj::resourceNames->set(HX_CSTRING("assets/source/test2.xml"),HX_CSTRING("assets_source_test2_xml"));
			HX_STACK_LINE(146)
