...
{
	HX_STACK_LINE(12)
	super::__construct(HX_CSTRING("button.png"),((::Mobile_obj::screenWidth - (int)44) - (int)10),(int)10,true);
	HX_STACK_LINE(14)
	this->asset_over = ::native::display::Bitmap_obj::__new(::nme::installer::Assets_obj::getBitmapData((::Mobile_obj::asset + HX_CSTRING("button2.png")),null()),null(),null());
}
;
	return null();
}
