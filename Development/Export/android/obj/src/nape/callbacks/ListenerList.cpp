...
{
HX_STACK_PUSH("ListenerList::new","nape/callbacks/ListenerList.hx",234);
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
...
::nape::callbacks::ListenerList ListenerList_obj::filter( Dynamic lambda){
	HX_STACK_PUSH("ListenerList::filter","nape/callbacks/ListenerList.hx",779);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::callbacks::ListenerList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/callbacks/ListenerList.hx",784);
			{
				HX_STACK_LINE(784)
...
::nape::callbacks::ListenerList ListenerList_obj::foreach( Dynamic lambda){
	HX_STACK_PUSH("ListenerList::foreach","nape/callbacks/ListenerList.hx",732);
	HX_STACK_THIS(this);
	HX_STACK_ARG(lambda,"lambda");
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static ::nape::callbacks::ListenerIterator Block( ::nape::callbacks::ListenerList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/callbacks/ListenerList.hx",736);
			{
				HX_STACK_LINE(736)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(736)
	...
	HX_STACK_LINE(736)
	::nape::callbacks::ListenerIterator it = _Function_1_1::Block(this);		HX_STACK_VAR(it,"it");
	struct _Function_1_2{
		inline static bool Block( ::nape::callbacks::ListenerIterator &it){
			HX_STACK_PUSH("*::closure","nape/callbacks/ListenerList.hx",737);
			{
				HX_STACK_LINE(737)
				it->zpp_inner->zpp_inner->valmod();
				struct _Function_2_1{
					inline static int Block( ::nape::callbacks::ListenerIterator &it){
						HX_STACK_PUSH("*::closure","nape/callbacks/ListenerList.hx",737);
						{
							HX_STACK_LINE(737)
		...
		try{
			struct _Function_3_1{
				inline static ::nape::callbacks::Listener Block( ::nape::callbacks::ListenerIterator &it){
					HX_STACK_PUSH("*::closure","nape/callbacks/ListenerList.hx",739);
					{
						HX_STACK_LINE(739)
...
::String ListenerList_obj::toString( ){
	HX_STACK_PUSH("ListenerList::toString","nape/callbacks/ListenerList.hx",702);
	HX_STACK_THIS(this);
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::callbacks::ListenerIterator Block( ::nape::callbacks::ListenerList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/callbacks/ListenerList.hx",705);
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
...
{
		HX_STACK_PUSH("ListenerList::merge","nape/callbacks/ListenerList.hx",684);
		HX_STACK_THIS(this);
		HX_STACK_ARG(xs,"xs");
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::callbacks::ListenerIterator Block( ::nape::callbacks::ListenerList &xs){
				HX_STACK_PUSH("*::closure","nape/callbacks/ListenerList.hx",688);
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
...
bool deep = __o_deep.Default(false);
	HX_STACK_PUSH("ListenerList::copy","nape/callbacks/ListenerList.hx",662);
	HX_STACK_THIS(this);
	HX_STACK_ARG(deep,"deep");
{
		...
		struct _Function_1_1{
			inline static ::nape::callbacks::ListenerIterator Block( ::nape::callbacks::ListenerList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/callbacks/ListenerList.hx",664);
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::callbacks::Listener Block( ){
				...
				{
					HX_STACK_LINE(666)
					hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("Listener")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
...
::nape::callbacks::ListenerIterator ListenerList_obj::iterator( ){
	HX_STACK_PUSH("ListenerList::iterator","nape/callbacks/ListenerList.hx",647);
	HX_STACK_THIS(this);
	HX_STACK_LINE(648)
...
bool ListenerList_obj::empty( ){
	HX_STACK_PUSH("ListenerList::empty","nape/callbacks/ListenerList.hx",631);
	HX_STACK_THIS(this);
	HX_STACK_LINE(631)
...
{
		HX_STACK_PUSH("ListenerList::clear","nape/callbacks/ListenerList.hx",614);
		HX_STACK_THIS(this);
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("Listener")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(618)
...
bool ListenerList_obj::remove( ::nape::callbacks::Listener obj){
	HX_STACK_PUSH("ListenerList::remove","nape/callbacks/ListenerList.hx",576);
	HX_STACK_THIS(this);
...
bool ListenerList_obj::add( ::nape::callbacks::Listener obj){
	HX_STACK_PUSH("ListenerList::add","nape/callbacks/ListenerList.hx",563);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(563)
...
::nape::callbacks::Listener ListenerList_obj::shift( ){
	HX_STACK_PUSH("ListenerList::shift","nape/callbacks/ListenerList.hx",519);
	HX_STACK_THIS(this);
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::callbacks::ListenerList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/callbacks/ListenerList.hx",533);
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
		...
		HX_STACK_LINE(533)
		::zpp_nape::util::ZNPNode_ZPP_Listener ite = (  (((_Function_2_1::Block(this) == (int)1))) ? ::zpp_nape::util::ZNPNode_ZPP_Listener(null()) : ::zpp_nape::util::ZNPNode_ZPP_Listener(this->zpp_inner->inner->iterator_at((_Function_2_2::Block(this) - (int)2))) );		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(534)
		ret = (  (((ite == null()))) ? ::zpp_nape::callbacks::ZPP_Listener(this->zpp_inner->inner->head->elt) : ::zpp_nape::callbacks::ZPP_Listener(ite->next->elt) );
		HX_STACK_LINE(535)
...
::nape::callbacks::Listener ListenerList_obj::pop( ){
	HX_STACK_PUSH("ListenerList::pop","nape/callbacks/ListenerList.hx",478);
	HX_STACK_THIS(this);
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::callbacks::ListenerList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/callbacks/ListenerList.hx",498);
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool ListenerList_obj::unshift( ::nape::callbacks::Listener obj){
	HX_STACK_PUSH("ListenerList::unshift","nape/callbacks/ListenerList.hx",447);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::callbacks::ListenerList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/callbacks/ListenerList.hx",458);
						{
							HX_STACK_LINE(458)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(458)
				...
				HX_STACK_LINE(458)
				this->zpp_inner->push_ite = (  (((this->zpp_inner->inner->head == null()))) ? ::zpp_nape::util::ZNPNode_ZPP_Listener(null()) : ::zpp_nape::util::ZNPNode_ZPP_Listener(this->zpp_inner->inner->iterator_at((_Function_4_1::Block(this) - (int)1))) );
			}
			HX_STACK_LINE(459)
...
bool ListenerList_obj::push( ::nape::callbacks::Listener obj){
	HX_STACK_PUSH("ListenerList::push","nape/callbacks/ListenerList.hx",416);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
	...
	if ((cont)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::callbacks::ListenerList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/callbacks/ListenerList.hx",428);
						{
							HX_STACK_LINE(428)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(428)
...
::nape::callbacks::Listener ListenerList_obj::at( int index){
	HX_STACK_PUSH("ListenerList::at","nape/callbacks/ListenerList.hx",363);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::callbacks::ListenerList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/callbacks/ListenerList.hx",368);
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::callbacks::ListenerList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/callbacks/ListenerList.hx",370);
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool ListenerList_obj::has( ::nape::callbacks::Listener obj){
	HX_STACK_PUSH("ListenerList::has","nape/callbacks/ListenerList.hx",346);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int ListenerList_obj::get_length( ){
	HX_STACK_PUSH("ListenerList::get_length","nape/callbacks/ListenerList.hx",244);
	HX_STACK_THIS(this);
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
