...
{
HX_STACK_PUSH("InteractionGroupList::new","nape/dynamics/InteractionGroupList.hx",234);
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
...
::nape::dynamics::InteractionGroupList InteractionGroupList_obj::filter( Dynamic lambda){
	HX_STACK_PUSH("InteractionGroupList::filter","nape/dynamics/InteractionGroupList.hx",779);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupList.hx",784);
			{
				HX_STACK_LINE(784)
...
::nape::dynamics::InteractionGroupList InteractionGroupList_obj::foreach( Dynamic lambda){
	HX_STACK_PUSH("InteractionGroupList::foreach","nape/dynamics/InteractionGroupList.hx",732);
	HX_STACK_THIS(this);
	HX_STACK_ARG(lambda,"lambda");
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static ::nape::dynamics::InteractionGroupIterator Block( ::nape::dynamics::InteractionGroupList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupList.hx",736);
			{
				HX_STACK_LINE(736)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(736)
	...
	HX_STACK_LINE(736)
	::nape::dynamics::InteractionGroupIterator it = _Function_1_1::Block(this);		HX_STACK_VAR(it,"it");
	struct _Function_1_2{
		inline static bool Block( ::nape::dynamics::InteractionGroupIterator &it){
			HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupList.hx",737);
			{
				HX_STACK_LINE(737)
				it->zpp_inner->zpp_inner->valmod();
				struct _Function_2_1{
					inline static int Block( ::nape::dynamics::InteractionGroupIterator &it){
						HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupList.hx",737);
						{
							HX_STACK_LINE(737)
		...
		try{
			struct _Function_3_1{
				inline static ::nape::dynamics::InteractionGroup Block( ::nape::dynamics::InteractionGroupIterator &it){
					HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupList.hx",739);
					{
						HX_STACK_LINE(739)
...
::String InteractionGroupList_obj::toString( ){
	HX_STACK_PUSH("InteractionGroupList::toString","nape/dynamics/InteractionGroupList.hx",702);
	HX_STACK_THIS(this);
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::dynamics::InteractionGroupIterator Block( ::nape::dynamics::InteractionGroupList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupList.hx",705);
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
...
{
		HX_STACK_PUSH("InteractionGroupList::merge","nape/dynamics/InteractionGroupList.hx",684);
		HX_STACK_THIS(this);
		HX_STACK_ARG(xs,"xs");
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::dynamics::InteractionGroupIterator Block( ::nape::dynamics::InteractionGroupList &xs){
				HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupList.hx",688);
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
...
bool deep = __o_deep.Default(false);
	HX_STACK_PUSH("InteractionGroupList::copy","nape/dynamics/InteractionGroupList.hx",662);
	HX_STACK_THIS(this);
	HX_STACK_ARG(deep,"deep");
{
		...
		struct _Function_1_1{
			inline static ::nape::dynamics::InteractionGroupIterator Block( ::nape::dynamics::InteractionGroupList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupList.hx",664);
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::dynamics::InteractionGroup Block( ){
				...
				{
					HX_STACK_LINE(666)
					hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("InteractionGroup")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
...
::nape::dynamics::InteractionGroupIterator InteractionGroupList_obj::iterator( ){
	HX_STACK_PUSH("InteractionGroupList::iterator","nape/dynamics/InteractionGroupList.hx",647);
	HX_STACK_THIS(this);
	HX_STACK_LINE(648)
...
bool InteractionGroupList_obj::empty( ){
	HX_STACK_PUSH("InteractionGroupList::empty","nape/dynamics/InteractionGroupList.hx",631);
	HX_STACK_THIS(this);
	HX_STACK_LINE(631)
...
{
		HX_STACK_PUSH("InteractionGroupList::clear","nape/dynamics/InteractionGroupList.hx",614);
		HX_STACK_THIS(this);
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("InteractionGroup")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(618)
...
bool InteractionGroupList_obj::remove( ::nape::dynamics::InteractionGroup obj){
	HX_STACK_PUSH("InteractionGroupList::remove","nape/dynamics/InteractionGroupList.hx",576);
	HX_STACK_THIS(this);
...
bool InteractionGroupList_obj::add( ::nape::dynamics::InteractionGroup obj){
	HX_STACK_PUSH("InteractionGroupList::add","nape/dynamics/InteractionGroupList.hx",563);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(563)
...
::nape::dynamics::InteractionGroup InteractionGroupList_obj::shift( ){
	HX_STACK_PUSH("InteractionGroupList::shift","nape/dynamics/InteractionGroupList.hx",519);
	HX_STACK_THIS(this);
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupList.hx",533);
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
		...
		HX_STACK_LINE(533)
		::zpp_nape::util::ZNPNode_ZPP_InteractionGroup ite = (  (((_Function_2_1::Block(this) == (int)1))) ? ::zpp_nape::util::ZNPNode_ZPP_InteractionGroup(null()) : ::zpp_nape::util::ZNPNode_ZPP_InteractionGroup(this->zpp_inner->inner->iterator_at((_Function_2_2::Block(this) - (int)2))) );		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(534)
		ret = (  (((ite == null()))) ? ::zpp_nape::dynamics::ZPP_InteractionGroup(this->zpp_inner->inner->head->elt) : ::zpp_nape::dynamics::ZPP_InteractionGroup(ite->next->elt) );
		HX_STACK_LINE(535)
...
::nape::dynamics::InteractionGroup InteractionGroupList_obj::pop( ){
	HX_STACK_PUSH("InteractionGroupList::pop","nape/dynamics/InteractionGroupList.hx",478);
	HX_STACK_THIS(this);
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupList.hx",498);
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool InteractionGroupList_obj::unshift( ::nape::dynamics::InteractionGroup obj){
	HX_STACK_PUSH("InteractionGroupList::unshift","nape/dynamics/InteractionGroupList.hx",447);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupList.hx",458);
						{
							HX_STACK_LINE(458)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(458)
				...
				HX_STACK_LINE(458)
				this->zpp_inner->push_ite = (  (((this->zpp_inner->inner->head == null()))) ? ::zpp_nape::util::ZNPNode_ZPP_InteractionGroup(null()) : ::zpp_nape::util::ZNPNode_ZPP_InteractionGroup(this->zpp_inner->inner->iterator_at((_Function_4_1::Block(this) - (int)1))) );
			}
			HX_STACK_LINE(459)
...
bool InteractionGroupList_obj::push( ::nape::dynamics::InteractionGroup obj){
	HX_STACK_PUSH("InteractionGroupList::push","nape/dynamics/InteractionGroupList.hx",416);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
	...
	if ((cont)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupList.hx",428);
						{
							HX_STACK_LINE(428)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(428)
...
::nape::dynamics::InteractionGroup InteractionGroupList_obj::at( int index){
	HX_STACK_PUSH("InteractionGroupList::at","nape/dynamics/InteractionGroupList.hx",363);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupList.hx",368);
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::dynamics::InteractionGroupList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupList.hx",370);
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool InteractionGroupList_obj::has( ::nape::dynamics::InteractionGroup obj){
	HX_STACK_PUSH("InteractionGroupList::has","nape/dynamics/InteractionGroupList.hx",346);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int InteractionGroupList_obj::get_length( ){
	HX_STACK_PUSH("InteractionGroupList::get_length","nape/dynamics/InteractionGroupList.hx",244);
	HX_STACK_THIS(this);
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::dynamics::InteractionGroupList InteractionGroupList_obj::fromArray( Array< ::nape::dynamics::InteractionGroup > array){
	HX_STACK_PUSH("InteractionGroupList::fromArray","nape/dynamics/InteractionGroupList.hx",304);
	...
	HX_STACK_LINE(311)
	{
		...
		while(((_g < array->length))){
			HX_STACK_LINE(311)
			::nape::dynamics::InteractionGroup i = array->__get(_g);		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			ret->push(i);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("nape.dynamics.InteractionGroupList"), hx::TCanCast< InteractionGroupList_obj> ,sStaticFields,sMemberFields,
