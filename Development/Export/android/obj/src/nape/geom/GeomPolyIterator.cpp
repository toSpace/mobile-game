...
{
HX_STACK_PUSH("GeomPolyIterator::new","nape/geom/GeomPolyIterator.hx",178);
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_GeomPolyList_obj::internal))){
		HX_STACK_LINE(204)
		hx::Throw (((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("GeomPoly")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::geom::GeomPoly GeomPolyIterator_obj::next( ){
	HX_STACK_PUSH("GeomPolyIterator::next","nape/geom/GeomPolyIterator.hx",264);
	HX_STACK_THIS(this);
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool GeomPolyIterator_obj::hasNext( ){
	HX_STACK_PUSH("GeomPolyIterator::hasNext","nape/geom/GeomPolyIterator.hx",240);
	HX_STACK_THIS(this);
	HX_STACK_LINE(241)
	this->zpp_inner->zpp_inner->valmod();
	struct _Function_1_1{
		inline static int Block( ::nape::geom::GeomPolyIterator_obj *__this){
			HX_STACK_PUSH("*::closure","nape/geom/GeomPolyIterator.hx",244);
			{
				HX_STACK_LINE(244)
				::nape::geom::GeomPolyList _this = __this->zpp_inner;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(244)
...
::nape::geom::GeomPolyIterator GeomPolyIterator_obj::get( ::nape::geom::GeomPolyList list){
	HX_STACK_PUSH("GeomPolyIterator::get","nape/geom/GeomPolyIterator.hx",217);
	HX_STACK_ARG(list,"list");
	struct _Function_1_1{
		inline static ::nape::geom::GeomPolyIterator Block( ){
			HX_STACK_PUSH("*::closure","nape/geom/GeomPolyIterator.hx",218);
			{
				HX_STACK_LINE(219)
	...
	struct _Function_1_2{
		inline static ::nape::geom::GeomPolyIterator Block( ){
			HX_STACK_PUSH("*::closure","nape/geom/GeomPolyIterator.hx",224);
			{
				HX_STACK_LINE(225)
	...
	HX_STACK_LINE(218)
	::nape::geom::GeomPolyIterator ret = (  (((::nape::geom::GeomPolyIterator_obj::zpp_pool == null()))) ? ::nape::geom::GeomPolyIterator(_Function_1_1::Block()) : ::nape::geom::GeomPolyIterator(_Function_1_2::Block()) );		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(229)
	ret->zpp_i = (int)0;
	HX_STACK_LINE(230)
	ret->zpp_inner = list;
