...
{
HX_STACK_PUSH("ShapeList::new","nape/shape/ShapeList.hx",234);
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
...
::nape::shape::ShapeList ShapeList_obj::filter( Dynamic lambda){
	HX_STACK_PUSH("ShapeList::filter","nape/shape/ShapeList.hx",779);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::shape::ShapeList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/shape/ShapeList.hx",784);
			{
				HX_STACK_LINE(784)
...
::nape::shape::ShapeList ShapeList_obj::foreach( Dynamic lambda){
	HX_STACK_PUSH("ShapeList::foreach","nape/shape/ShapeList.hx",732);
	HX_STACK_THIS(this);
	HX_STACK_ARG(lambda,"lambda");
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static ::nape::shape::ShapeIterator Block( ::nape::shape::ShapeList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/shape/ShapeList.hx",736);
			{
				HX_STACK_LINE(736)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(736)
	...
	HX_STACK_LINE(736)
	::nape::shape::ShapeIterator it = _Function_1_1::Block(this);		HX_STACK_VAR(it,"it");
	struct _Function_1_2{
		inline static bool Block( ::nape::shape::ShapeIterator &it){
			HX_STACK_PUSH("*::closure","nape/shape/ShapeList.hx",737);
			{
				HX_STACK_LINE(737)
				it->zpp_inner->zpp_inner->valmod();
				struct _Function_2_1{
					inline static int Block( ::nape::shape::ShapeIterator &it){
						HX_STACK_PUSH("*::closure","nape/shape/ShapeList.hx",737);
						{
							HX_STACK_LINE(737)
		...
		try{
			struct _Function_3_1{
				inline static ::nape::shape::Shape Block( ::nape::shape::ShapeIterator &it){
					HX_STACK_PUSH("*::closure","nape/shape/ShapeList.hx",739);
					{
						HX_STACK_LINE(739)
...
::String ShapeList_obj::toString( ){
	HX_STACK_PUSH("ShapeList::toString","nape/shape/ShapeList.hx",702);
	HX_STACK_THIS(this);
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::shape::ShapeIterator Block( ::nape::shape::ShapeList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/shape/ShapeList.hx",705);
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
...
{
		HX_STACK_PUSH("ShapeList::merge","nape/shape/ShapeList.hx",684);
		HX_STACK_THIS(this);
		HX_STACK_ARG(xs,"xs");
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::shape::ShapeIterator Block( ::nape::shape::ShapeList &xs){
				HX_STACK_PUSH("*::closure","nape/shape/ShapeList.hx",688);
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
...
bool deep = __o_deep.Default(false);
	HX_STACK_PUSH("ShapeList::copy","nape/shape/ShapeList.hx",662);
	HX_STACK_THIS(this);
	HX_STACK_ARG(deep,"deep");
{
		...
		struct _Function_1_1{
			inline static ::nape::shape::ShapeIterator Block( ::nape::shape::ShapeList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/shape/ShapeList.hx",664);
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::shape::Shape Block( ){
				...
				{
					HX_STACK_LINE(666)
					hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("Shape")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
...
::nape::shape::ShapeIterator ShapeList_obj::iterator( ){
	HX_STACK_PUSH("ShapeList::iterator","nape/shape/ShapeList.hx",647);
	HX_STACK_THIS(this);
	HX_STACK_LINE(648)
...
bool ShapeList_obj::empty( ){
	HX_STACK_PUSH("ShapeList::empty","nape/shape/ShapeList.hx",631);
	HX_STACK_THIS(this);
	HX_STACK_LINE(631)
...
{
		HX_STACK_PUSH("ShapeList::clear","nape/shape/ShapeList.hx",614);
		HX_STACK_THIS(this);
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("Shape")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(618)
...
bool ShapeList_obj::remove( ::nape::shape::Shape obj){
	HX_STACK_PUSH("ShapeList::remove","nape/shape/ShapeList.hx",576);
	HX_STACK_THIS(this);
...
bool ShapeList_obj::add( ::nape::shape::Shape obj){
	HX_STACK_PUSH("ShapeList::add","nape/shape/ShapeList.hx",563);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(563)
...
::nape::shape::Shape ShapeList_obj::shift( ){
	HX_STACK_PUSH("ShapeList::shift","nape/shape/ShapeList.hx",519);
	HX_STACK_THIS(this);
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::shape::ShapeList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/shape/ShapeList.hx",533);
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
		...
		HX_STACK_LINE(533)
		::zpp_nape::util::ZNPNode_ZPP_Shape ite = (  (((_Function_2_1::Block(this) == (int)1))) ? ::zpp_nape::util::ZNPNode_ZPP_Shape(null()) : ::zpp_nape::util::ZNPNode_ZPP_Shape(this->zpp_inner->inner->iterator_at((_Function_2_2::Block(this) - (int)2))) );		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(534)
		ret = (  (((ite == null()))) ? ::zpp_nape::shape::ZPP_Shape(this->zpp_inner->inner->head->elt) : ::zpp_nape::shape::ZPP_Shape(ite->next->elt) );
		HX_STACK_LINE(535)
...
::nape::shape::Shape ShapeList_obj::pop( ){
	HX_STACK_PUSH("ShapeList::pop","nape/shape/ShapeList.hx",478);
	HX_STACK_THIS(this);
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::shape::ShapeList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/shape/ShapeList.hx",498);
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool ShapeList_obj::unshift( ::nape::shape::Shape obj){
	HX_STACK_PUSH("ShapeList::unshift","nape/shape/ShapeList.hx",447);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::shape::ShapeList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/shape/ShapeList.hx",458);
						{
							HX_STACK_LINE(458)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(458)
				...
				HX_STACK_LINE(458)
				this->zpp_inner->push_ite = (  (((this->zpp_inner->inner->head == null()))) ? ::zpp_nape::util::ZNPNode_ZPP_Shape(null()) : ::zpp_nape::util::ZNPNode_ZPP_Shape(this->zpp_inner->inner->iterator_at((_Function_4_1::Block(this) - (int)1))) );
			}
			HX_STACK_LINE(459)
...
bool ShapeList_obj::push( ::nape::shape::Shape obj){
	HX_STACK_PUSH("ShapeList::push","nape/shape/ShapeList.hx",416);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
	...
	if ((cont)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::shape::ShapeList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/shape/ShapeList.hx",428);
						{
							HX_STACK_LINE(428)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(428)
...
::nape::shape::Shape ShapeList_obj::at( int index){
	HX_STACK_PUSH("ShapeList::at","nape/shape/ShapeList.hx",363);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::shape::ShapeList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/shape/ShapeList.hx",368);
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::shape::ShapeList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/shape/ShapeList.hx",370);
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool ShapeList_obj::has( ::nape::shape::Shape obj){
	HX_STACK_PUSH("ShapeList::has","nape/shape/ShapeList.hx",346);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int ShapeList_obj::get_length( ){
	HX_STACK_PUSH("ShapeList::get_length","nape/shape/ShapeList.hx",244);
	HX_STACK_THIS(this);
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
