...
{
HX_STACK_PUSH("EdgeList::new","nape/shape/EdgeList.hx",234);
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
...
::nape::shape::EdgeList EdgeList_obj::filter( Dynamic lambda){
	HX_STACK_PUSH("EdgeList::filter","nape/shape/EdgeList.hx",779);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::shape::EdgeList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/shape/EdgeList.hx",784);
			{
				HX_STACK_LINE(784)
...
::nape::shape::EdgeList EdgeList_obj::foreach( Dynamic lambda){
	HX_STACK_PUSH("EdgeList::foreach","nape/shape/EdgeList.hx",732);
	HX_STACK_THIS(this);
	HX_STACK_ARG(lambda,"lambda");
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static ::nape::shape::EdgeIterator Block( ::nape::shape::EdgeList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/shape/EdgeList.hx",736);
			{
				HX_STACK_LINE(736)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(736)
	...
	HX_STACK_LINE(736)
	::nape::shape::EdgeIterator it = _Function_1_1::Block(this);		HX_STACK_VAR(it,"it");
	struct _Function_1_2{
		inline static bool Block( ::nape::shape::EdgeIterator &it){
			HX_STACK_PUSH("*::closure","nape/shape/EdgeList.hx",737);
			{
				HX_STACK_LINE(737)
				it->zpp_inner->zpp_inner->valmod();
				struct _Function_2_1{
					inline static int Block( ::nape::shape::EdgeIterator &it){
						HX_STACK_PUSH("*::closure","nape/shape/EdgeList.hx",737);
						{
							HX_STACK_LINE(737)
		...
		try{
			struct _Function_3_1{
				inline static ::nape::shape::Edge Block( ::nape::shape::EdgeIterator &it){
					HX_STACK_PUSH("*::closure","nape/shape/EdgeList.hx",739);
					{
						HX_STACK_LINE(739)
...
::String EdgeList_obj::toString( ){
	HX_STACK_PUSH("EdgeList::toString","nape/shape/EdgeList.hx",702);
	HX_STACK_THIS(this);
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::shape::EdgeIterator Block( ::nape::shape::EdgeList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/shape/EdgeList.hx",705);
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
...
{
		HX_STACK_PUSH("EdgeList::merge","nape/shape/EdgeList.hx",684);
		HX_STACK_THIS(this);
		HX_STACK_ARG(xs,"xs");
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::shape::EdgeIterator Block( ::nape::shape::EdgeList &xs){
				HX_STACK_PUSH("*::closure","nape/shape/EdgeList.hx",688);
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
...
bool deep = __o_deep.Default(false);
	HX_STACK_PUSH("EdgeList::copy","nape/shape/EdgeList.hx",662);
	HX_STACK_THIS(this);
	HX_STACK_ARG(deep,"deep");
{
		...
		struct _Function_1_1{
			inline static ::nape::shape::EdgeIterator Block( ::nape::shape::EdgeList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/shape/EdgeList.hx",664);
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::shape::Edge Block( ){
				...
				{
					HX_STACK_LINE(666)
					hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("Edge")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
...
::nape::shape::EdgeIterator EdgeList_obj::iterator( ){
	HX_STACK_PUSH("EdgeList::iterator","nape/shape/EdgeList.hx",647);
	HX_STACK_THIS(this);
	HX_STACK_LINE(648)
...
bool EdgeList_obj::empty( ){
	HX_STACK_PUSH("EdgeList::empty","nape/shape/EdgeList.hx",631);
	HX_STACK_THIS(this);
	HX_STACK_LINE(631)
...
{
		HX_STACK_PUSH("EdgeList::clear","nape/shape/EdgeList.hx",614);
		HX_STACK_THIS(this);
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("Edge")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(618)
...
bool EdgeList_obj::remove( ::nape::shape::Edge obj){
	HX_STACK_PUSH("EdgeList::remove","nape/shape/EdgeList.hx",576);
	HX_STACK_THIS(this);
...
bool EdgeList_obj::add( ::nape::shape::Edge obj){
	HX_STACK_PUSH("EdgeList::add","nape/shape/EdgeList.hx",563);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(563)
...
::nape::shape::Edge EdgeList_obj::shift( ){
	HX_STACK_PUSH("EdgeList::shift","nape/shape/EdgeList.hx",519);
	HX_STACK_THIS(this);
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::shape::EdgeList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/shape/EdgeList.hx",533);
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
		...
		HX_STACK_LINE(533)
		::zpp_nape::util::ZNPNode_ZPP_Edge ite = (  (((_Function_2_1::Block(this) == (int)1))) ? ::zpp_nape::util::ZNPNode_ZPP_Edge(null()) : ::zpp_nape::util::ZNPNode_ZPP_Edge(this->zpp_inner->inner->iterator_at((_Function_2_2::Block(this) - (int)2))) );		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(534)
		ret = (  (((ite == null()))) ? ::zpp_nape::shape::ZPP_Edge(this->zpp_inner->inner->head->elt) : ::zpp_nape::shape::ZPP_Edge(ite->next->elt) );
		HX_STACK_LINE(535)
...
::nape::shape::Edge EdgeList_obj::pop( ){
	HX_STACK_PUSH("EdgeList::pop","nape/shape/EdgeList.hx",478);
	HX_STACK_THIS(this);
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::shape::EdgeList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/shape/EdgeList.hx",498);
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool EdgeList_obj::unshift( ::nape::shape::Edge obj){
	HX_STACK_PUSH("EdgeList::unshift","nape/shape/EdgeList.hx",447);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::shape::EdgeList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/shape/EdgeList.hx",458);
						{
							HX_STACK_LINE(458)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(458)
				...
				HX_STACK_LINE(458)
				this->zpp_inner->push_ite = (  (((this->zpp_inner->inner->head == null()))) ? ::zpp_nape::util::ZNPNode_ZPP_Edge(null()) : ::zpp_nape::util::ZNPNode_ZPP_Edge(this->zpp_inner->inner->iterator_at((_Function_4_1::Block(this) - (int)1))) );
			}
			HX_STACK_LINE(459)
...
bool EdgeList_obj::push( ::nape::shape::Edge obj){
	HX_STACK_PUSH("EdgeList::push","nape/shape/EdgeList.hx",416);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
	...
	if ((cont)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::shape::EdgeList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/shape/EdgeList.hx",428);
						{
							HX_STACK_LINE(428)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(428)
...
::nape::shape::Edge EdgeList_obj::at( int index){
	HX_STACK_PUSH("EdgeList::at","nape/shape/EdgeList.hx",363);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::shape::EdgeList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/shape/EdgeList.hx",368);
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::shape::EdgeList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/shape/EdgeList.hx",370);
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
		...
		HX_STACK_LINE(370)
		index = (  (((index == (_Function_2_1::Block(this) - (int)1)))) ? int(index) : int(((_Function_2_2::Block(this) - (int)2) - index)) );
	}
	HX_STACK_LINE(371)
...
bool EdgeList_obj::has( ::nape::shape::Edge obj){
	HX_STACK_PUSH("EdgeList::has","nape/shape/EdgeList.hx",346);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int EdgeList_obj::get_length( ){
	HX_STACK_PUSH("EdgeList::get_length","nape/shape/EdgeList.hx",244);
	HX_STACK_THIS(this);
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
