...
{
HX_STACK_PUSH("ConvexResultIterator::new","nape/geom/ConvexResultIterator.hx",178);
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_ConvexResultList_obj::internal))){
		HX_STACK_LINE(204)
		hx::Throw (((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("ConvexResult")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::geom::ConvexResult ConvexResultIterator_obj::next( ){
	HX_STACK_PUSH("ConvexResultIterator::next","nape/geom/ConvexResultIterator.hx",264);
	HX_STACK_THIS(this);
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool ConvexResultIterator_obj::hasNext( ){
	HX_STACK_PUSH("ConvexResultIterator::hasNext","nape/geom/ConvexResultIterator.hx",240);
	HX_STACK_THIS(this);
	HX_STACK_LINE(241)
	this->zpp_inner->zpp_inner->valmod();
	struct _Function_1_1{
		inline static int Block( ::nape::geom::ConvexResultIterator_obj *__this){
			HX_STACK_PUSH("*::closure","nape/geom/ConvexResultIterator.hx",244);
			{
				HX_STACK_LINE(244)
				::nape::geom::ConvexResultList _this = __this->zpp_inner;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(244)
...
::nape::geom::ConvexResultIterator ConvexResultIterator_obj::get( ::nape::geom::ConvexResultList list){
	HX_STACK_PUSH("ConvexResultIterator::get","nape/geom/ConvexResultIterator.hx",217);
	HX_STACK_ARG(list,"list");
	struct _Function_1_1{
		inline static ::nape::geom::ConvexResultIterator Block( ){
			HX_STACK_PUSH("*::closure","nape/geom/ConvexResultIterator.hx",218);
			{
				HX_STACK_LINE(219)
	...
	struct _Function_1_2{
		inline static ::nape::geom::ConvexResultIterator Block( ){
			HX_STACK_PUSH("*::closure","nape/geom/ConvexResultIterator.hx",224);
			{
				HX_STACK_LINE(225)
	...
	HX_STACK_LINE(218)
	::nape::geom::ConvexResultIterator ret = (  (((::nape::geom::ConvexResultIterator_obj::zpp_pool == null()))) ? ::nape::geom::ConvexResultIterator(_Function_1_1::Block()) : ::nape::geom::ConvexResultIterator(_Function_1_2::Block()) );		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(229)
	ret->zpp_i = (int)0;
	HX_STACK_LINE(230)
	ret->zpp_inner = list;
