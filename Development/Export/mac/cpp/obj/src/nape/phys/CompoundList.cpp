...
{
HX_STACK_PUSH("CompoundList::new","nape/phys/CompoundList.hx",234);
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
...
::nape::phys::CompoundList CompoundList_obj::filter( Dynamic lambda){
	HX_STACK_PUSH("CompoundList::filter","nape/phys/CompoundList.hx",779);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::phys::CompoundList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/phys/CompoundList.hx",784);
			{
				HX_STACK_LINE(784)
...
::nape::phys::CompoundList CompoundList_obj::foreach( Dynamic lambda){
	HX_STACK_PUSH("CompoundList::foreach","nape/phys/CompoundList.hx",732);
	HX_STACK_THIS(this);
	HX_STACK_ARG(lambda,"lambda");
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static ::nape::phys::CompoundIterator Block( ::nape::phys::CompoundList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/phys/CompoundList.hx",736);
			{
				HX_STACK_LINE(736)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(736)
	...
	HX_STACK_LINE(736)
	::nape::phys::CompoundIterator it = _Function_1_1::Block(this);		HX_STACK_VAR(it,"it");
	struct _Function_1_2{
		inline static bool Block( ::nape::phys::CompoundIterator &it){
			HX_STACK_PUSH("*::closure","nape/phys/CompoundList.hx",737);
			{
				HX_STACK_LINE(737)
				it->zpp_inner->zpp_inner->valmod();
				struct _Function_2_1{
					inline static int Block( ::nape::phys::CompoundIterator &it){
						HX_STACK_PUSH("*::closure","nape/phys/CompoundList.hx",737);
						{
							HX_STACK_LINE(737)
		...
		try{
			struct _Function_3_1{
				inline static ::nape::phys::Compound Block( ::nape::phys::CompoundIterator &it){
					HX_STACK_PUSH("*::closure","nape/phys/CompoundList.hx",739);
					{
						HX_STACK_LINE(739)
...
::String CompoundList_obj::toString( ){
	HX_STACK_PUSH("CompoundList::toString","nape/phys/CompoundList.hx",702);
	HX_STACK_THIS(this);
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::phys::CompoundIterator Block( ::nape::phys::CompoundList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/phys/CompoundList.hx",705);
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
...
{
		HX_STACK_PUSH("CompoundList::merge","nape/phys/CompoundList.hx",684);
		HX_STACK_THIS(this);
		HX_STACK_ARG(xs,"xs");
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::phys::CompoundIterator Block( ::nape::phys::CompoundList &xs){
				HX_STACK_PUSH("*::closure","nape/phys/CompoundList.hx",688);
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
...
bool deep = __o_deep.Default(false);
	HX_STACK_PUSH("CompoundList::copy","nape/phys/CompoundList.hx",662);
	HX_STACK_THIS(this);
	HX_STACK_ARG(deep,"deep");
{
		...
		struct _Function_1_1{
			inline static ::nape::phys::CompoundIterator Block( ::nape::phys::CompoundList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/phys/CompoundList.hx",664);
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::phys::Compound Block( ){
				...
				{
					HX_STACK_LINE(666)
					hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("Compound")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
...
::nape::phys::CompoundIterator CompoundList_obj::iterator( ){
	HX_STACK_PUSH("CompoundList::iterator","nape/phys/CompoundList.hx",647);
	HX_STACK_THIS(this);
	HX_STACK_LINE(648)
...
bool CompoundList_obj::empty( ){
	HX_STACK_PUSH("CompoundList::empty","nape/phys/CompoundList.hx",631);
	HX_STACK_THIS(this);
	HX_STACK_LINE(631)
...
{
		HX_STACK_PUSH("CompoundList::clear","nape/phys/CompoundList.hx",614);
		HX_STACK_THIS(this);
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("Compound")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(618)
...
bool CompoundList_obj::remove( ::nape::phys::Compound obj){
	HX_STACK_PUSH("CompoundList::remove","nape/phys/CompoundList.hx",576);
	HX_STACK_THIS(this);
...
bool CompoundList_obj::add( ::nape::phys::Compound obj){
	HX_STACK_PUSH("CompoundList::add","nape/phys/CompoundList.hx",563);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(563)
...
::nape::phys::Compound CompoundList_obj::shift( ){
	HX_STACK_PUSH("CompoundList::shift","nape/phys/CompoundList.hx",519);
	HX_STACK_THIS(this);
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::phys::CompoundList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/phys/CompoundList.hx",533);
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
		...
		HX_STACK_LINE(533)
		::zpp_nape::util::ZNPNode_ZPP_Compound ite = (  (((_Function_2_1::Block(this) == (int)1))) ? ::zpp_nape::util::ZNPNode_ZPP_Compound(null()) : ::zpp_nape::util::ZNPNode_ZPP_Compound(this->zpp_inner->inner->iterator_at((_Function_2_2::Block(this) - (int)2))) );		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(534)
		ret = (  (((ite == null()))) ? ::zpp_nape::phys::ZPP_Compound(this->zpp_inner->inner->head->elt) : ::zpp_nape::phys::ZPP_Compound(ite->next->elt) );
		HX_STACK_LINE(535)
...
::nape::phys::Compound CompoundList_obj::pop( ){
	HX_STACK_PUSH("CompoundList::pop","nape/phys/CompoundList.hx",478);
	HX_STACK_THIS(this);
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::phys::CompoundList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/phys/CompoundList.hx",498);
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool CompoundList_obj::unshift( ::nape::phys::Compound obj){
	HX_STACK_PUSH("CompoundList::unshift","nape/phys/CompoundList.hx",447);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::phys::CompoundList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/phys/CompoundList.hx",458);
						{
							HX_STACK_LINE(458)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(458)
				...
				HX_STACK_LINE(458)
				this->zpp_inner->push_ite = (  (((this->zpp_inner->inner->head == null()))) ? ::zpp_nape::util::ZNPNode_ZPP_Compound(null()) : ::zpp_nape::util::ZNPNode_ZPP_Compound(this->zpp_inner->inner->iterator_at((_Function_4_1::Block(this) - (int)1))) );
			}
			HX_STACK_LINE(459)
...
bool CompoundList_obj::push( ::nape::phys::Compound obj){
	HX_STACK_PUSH("CompoundList::push","nape/phys/CompoundList.hx",416);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
	...
	if ((cont)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::phys::CompoundList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/phys/CompoundList.hx",428);
						{
							HX_STACK_LINE(428)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(428)
...
::nape::phys::Compound CompoundList_obj::at( int index){
	HX_STACK_PUSH("CompoundList::at","nape/phys/CompoundList.hx",363);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::phys::CompoundList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/phys/CompoundList.hx",368);
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::phys::CompoundList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/phys/CompoundList.hx",370);
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool CompoundList_obj::has( ::nape::phys::Compound obj){
	HX_STACK_PUSH("CompoundList::has","nape/phys/CompoundList.hx",346);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int CompoundList_obj::get_length( ){
	HX_STACK_PUSH("CompoundList::get_length","nape/phys/CompoundList.hx",244);
	HX_STACK_THIS(this);
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::phys::CompoundList CompoundList_obj::fromArray( Array< ::nape::phys::Compound > array){
	HX_STACK_PUSH("CompoundList::fromArray","nape/phys/CompoundList.hx",304);
	...
	HX_STACK_LINE(311)
	{
		...
		while(((_g < array->length))){
			HX_STACK_LINE(311)
			::nape::phys::Compound i = array->__get(_g);		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			ret->push(i);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("nape.phys.CompoundList"), hx::TCanCast< CompoundList_obj> ,sStaticFields,sMemberFields,
