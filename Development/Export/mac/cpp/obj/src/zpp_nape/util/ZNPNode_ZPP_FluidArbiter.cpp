...
{
HX_STACK_PUSH("ZNPNode_ZPP_FluidArbiter::new","zpp_nape/util/Lists.hx",15889);
{
	HX_STACK_LINE(15923)
	this->elt = null();
	HX_STACK_LINE(15914)
...
::zpp_nape::dynamics::ZPP_FluidArbiter ZNPNode_ZPP_FluidArbiter_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_FluidArbiter::elem","zpp_nape/util/Lists.hx",15927);
	HX_STACK_THIS(this);
	HX_STACK_LINE(15927)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_FluidArbiter::free","zpp_nape/util/Lists.hx",15920);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15920)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_FluidArbiter::alloc","zpp_nape/util/Lists.hx",15917);
		HX_STACK_THIS(this);
	}
return null();
}
