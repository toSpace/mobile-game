...
{
HX_STACK_PUSH("ZNPNode_ZPP_Edge::new","zpp_nape/util/Lists.hx",15760);
{
	HX_STACK_LINE(15794)
	this->elt = null();
	HX_STACK_LINE(15785)
...
::zpp_nape::shape::ZPP_Edge ZNPNode_ZPP_Edge_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_Edge::elem","zpp_nape/util/Lists.hx",15798);
	HX_STACK_THIS(this);
	HX_STACK_LINE(15798)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Edge::free","zpp_nape/util/Lists.hx",15791);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15791)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Edge::alloc","zpp_nape/util/Lists.hx",15788);
		HX_STACK_THIS(this);
	}
return null();
}
