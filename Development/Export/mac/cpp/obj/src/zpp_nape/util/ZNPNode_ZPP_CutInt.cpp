...
{
HX_STACK_PUSH("ZNPNode_ZPP_CutInt::new","zpp_nape/util/Lists.hx",15330);
{
	HX_STACK_LINE(15364)
	this->elt = null();
	HX_STACK_LINE(15355)
...
::zpp_nape::geom::ZPP_CutInt ZNPNode_ZPP_CutInt_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_CutInt::elem","zpp_nape/util/Lists.hx",15368);
	HX_STACK_THIS(this);
	HX_STACK_LINE(15368)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_CutInt::free","zpp_nape/util/Lists.hx",15361);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15361)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_CutInt::alloc","zpp_nape/util/Lists.hx",15358);
		HX_STACK_THIS(this);
	}
return null();
}
