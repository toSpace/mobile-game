...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(84)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)640,(int)480,(int)60,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(::flash::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("Game"),null(),null());
	}
return null();
}
...
{
		HX_STACK_PUSH("ApplicationMain::applyScale","ApplicationMain.hx",167);
		HX_STACK_ARG(_,"_");
		HX_STACK_LINE(169)
...
Dynamic ApplicationMain_obj::getAsset( ::String inName){
	HX_STACK_PUSH("ApplicationMain::getAsset","ApplicationMain.hx",215);
