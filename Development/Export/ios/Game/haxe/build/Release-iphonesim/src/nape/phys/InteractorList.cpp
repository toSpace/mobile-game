...
::nape::phys::InteractorList InteractorList_obj::fromArray( Array< ::nape::phys::Interactor > array){
	...
	HX_STACK_LINE(311)
	{
		...
		while(((_g < array->length))){
			HX_STACK_LINE(311)
			::nape::phys::Interactor i = array->__get(_g);		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			ret->push(i);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("nape.phys.InteractorList"), hx::TCanCast< InteractorList_obj> ,sStaticFields,sMemberFields,
