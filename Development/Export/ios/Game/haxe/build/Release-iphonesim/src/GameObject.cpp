...
bool offset = __o_offset.Default(false);
	HX_STACK_PUSH("GameObject::setXY","GameObject.hx",91);
	HX_STACK_THIS(this);
	HX_STACK_ARG(x,"x");
	HX_STACK_ARG(y,"y");
...
{
		HX_STACK_PUSH("GameObject::hide","GameObject.hx",87);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
		HX_STACK_PUSH("GameObject::remove","GameObject.hx",76);
		HX_STACK_THIS(this);
		HX_STACK_LINE(78)
		this->hide();
		HX_STACK_LINE(81)
...
{
		HX_STACK_PUSH("GameObject::renderPhysics","GameObject.hx",65);
		HX_STACK_THIS(this);
		struct _Function_1_1{
			inline static Dynamic Block( ::GameObject_obj *__this){
				HX_STACK_PUSH("*::closure","GameObject.hx",67);
				{
					HX_STACK_LINE(67)
					::nape::phys::Body _this = __this->body;		HX_STACK_VAR(_this,"_this");
					HX_STACK_LINE(67)
		...
		struct _Function_1_3{
			inline static Float Block( ::nape::geom::Vec2 &position){
				HX_STACK_PUSH("*::closure","GameObject.hx",70);
				{
					HX_STACK_LINE(70)
...
{
		HX_STACK_PUSH("GameObject::render","GameObject.hx",61);
		HX_STACK_THIS(this);
		HX_STACK_LINE(61)
		this->renderPhysics();
	}
...
{
		HX_STACK_PUSH("GameObject::physicsObject","GameObject.hx",57);
		HX_STACK_THIS(this);
...
::Hash GameObject_obj::readXml( ::String url){
	HX_STACK_PUSH("GameObject::readXml","GameObject.hx",42);
	HX_STACK_THIS(this);
