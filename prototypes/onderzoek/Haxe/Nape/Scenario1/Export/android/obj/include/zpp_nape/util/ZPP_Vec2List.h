...
class ZPP_Vec2List_obj : public hx::Object{
	public:
	...
	public:
		...
		int user_length; /* REM */ 
		bool zip_length; /* REM */ 
		::zpp_nape::util::ZNPNode_ZPP_Vec2 push_ite; /* REM */ 
		::zpp_nape::util::ZNPNode_ZPP_Vec2 at_ite; /* REM */ 
		int at_index; /* REM */ 
		...
		bool immutable; /* REM */ 
		::zpp_nape::util::ZNPList_ZPP_Vec2 inner; /* REM */ 
		::nape::geom::Vec2List outer; /* REM */ 
