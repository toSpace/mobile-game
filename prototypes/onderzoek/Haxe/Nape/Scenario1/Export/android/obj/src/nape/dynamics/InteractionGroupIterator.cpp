...
{
HX_STACK_PUSH("InteractionGroupIterator::new","nape/dynamics/InteractionGroupIterator.hx",178);
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_InteractionGroupList_obj::internal))){
		HX_STACK_LINE(204)
		hx::Throw (((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("InteractionGroup")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::dynamics::InteractionGroup InteractionGroupIterator_obj::next( ){
	HX_STACK_PUSH("InteractionGroupIterator::next","nape/dynamics/InteractionGroupIterator.hx",264);
	HX_STACK_THIS(this);
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool InteractionGroupIterator_obj::hasNext( ){
	HX_STACK_PUSH("InteractionGroupIterator::hasNext","nape/dynamics/InteractionGroupIterator.hx",240);
	HX_STACK_THIS(this);
	HX_STACK_LINE(241)
	this->zpp_inner->zpp_inner->valmod();
	struct _Function_1_1{
		inline static int Block( ::nape::dynamics::InteractionGroupIterator_obj *__this){
			HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupIterator.hx",244);
			{
				HX_STACK_LINE(244)
				::nape::dynamics::InteractionGroupList _this = __this->zpp_inner;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(244)
...
::nape::dynamics::InteractionGroupIterator InteractionGroupIterator_obj::get( ::nape::dynamics::InteractionGroupList list){
	HX_STACK_PUSH("InteractionGroupIterator::get","nape/dynamics/InteractionGroupIterator.hx",217);
	HX_STACK_ARG(list,"list");
	struct _Function_1_1{
		inline static ::nape::dynamics::InteractionGroupIterator Block( ){
			HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupIterator.hx",218);
			{
				HX_STACK_LINE(219)
	...
	struct _Function_1_2{
		inline static ::nape::dynamics::InteractionGroupIterator Block( ){
			HX_STACK_PUSH("*::closure","nape/dynamics/InteractionGroupIterator.hx",224);
			{
				HX_STACK_LINE(225)
	...
	HX_STACK_LINE(218)
	::nape::dynamics::InteractionGroupIterator ret = (  (((::nape::dynamics::InteractionGroupIterator_obj::zpp_pool == null()))) ? ::nape::dynamics::InteractionGroupIterator(_Function_1_1::Block()) : ::nape::dynamics::InteractionGroupIterator(_Function_1_2::Block()) );		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(229)
	ret->zpp_i = (int)0;
	HX_STACK_LINE(230)
	ret->zpp_inner = list;
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("nape.dynamics.InteractionGroupIterator"), hx::TCanCast< InteractionGroupIterator_obj> ,sStaticFields,sMemberFields,
