...
{
HX_STACK_PUSH("ZNPNode_ZPP_Listener::new","zpp_nape/util/Lists.hx",15975);
{
	HX_STACK_LINE(16009)
	this->elt = null();
	HX_STACK_LINE(16000)
...
::zpp_nape::callbacks::ZPP_Listener ZNPNode_ZPP_Listener_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_Listener::elem","zpp_nape/util/Lists.hx",16013);
	HX_STACK_THIS(this);
	HX_STACK_LINE(16013)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Listener::free","zpp_nape/util/Lists.hx",16006);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16006)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Listener::alloc","zpp_nape/util/Lists.hx",16003);
		HX_STACK_THIS(this);
	}
return null();
}
