...
{
HX_STACK_PUSH("Main::new","Main.hx",26);
{
	HX_STACK_LINE(42)
...
{
		HX_STACK_PUSH("Main::updateGraphics","Main.hx",183);
		HX_STACK_THIS(this);
		HX_STACK_ARG(b,"b");
		...
		struct _Function_1_2{
			inline static Float Block( ::nape::geom::Vec3 &pos){
				HX_STACK_PUSH("*::closure","Main.hx",187);
				{
					HX_STACK_LINE(187)
...
{
		HX_STACK_PUSH("Main::enterFrameHandler","Main.hx",170);
		HX_STACK_THIS(this);
		HX_STACK_ARG(ev,"ev");
		HX_STACK_LINE(172)
		...
		HX_STACK_LINE(175)
		{
			...
			struct _Function_2_1{
				inline static ::nape::phys::BodyIterator Block( ::nape::phys::BodyList &_this){
					HX_STACK_PUSH("*::closure","Main.hx",175);
					{
						HX_STACK_LINE(175)
...
Dynamic Main_obj::getParticleType( ){
	HX_STACK_PUSH("Main::getParticleType","Main.hx",151);
	HX_STACK_THIS(this);
	HX_STACK_LINE(154)
...
{
		HX_STACK_PUSH("Main::addParticle","Main.hx",128);
		HX_STACK_THIS(this);
		HX_STACK_LINE(130)
		...
		HX_STACK_LINE(140)
		{
			struct _Function_2_1{
				inline static ::nape::geom::Vec2 Block( ::nape::phys::Body &Particle){
					HX_STACK_PUSH("*::closure","Main.hx",140);
					{
						HX_STACK_LINE(140)
...
{
		HX_STACK_PUSH("Main::createFloors","Main.hx",107);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_ARG(y,"y");
		...
		struct _Function_1_1{
			inline static ::nape::phys::BodyType Block( ){
				HX_STACK_PUSH("*::closure","Main.hx",110);
				{
					HX_STACK_LINE(110)
...
Void Main_obj::setUp( ){
{
		HX_STACK_PUSH("Main::setUp","Main.hx",79);
		HX_STACK_THIS(this);
		HX_STACK_LINE(79)
		...
		this->addParticle();
		HX_STACK_LINE(88)
		::haxe::Timer t = ::haxe::Timer_obj::__new((int)1000);		HX_STACK_VAR(t,"t");

		HX_BEGIN_LOCAL_FUNC_S1(hx::LocalFunc,_Function_1_1,Array< ::Main >,_g)
		Void run(){
			HX_STACK_PUSH("*::_Function_1_1","Main.hx",89);
			{
				HX_STACK_LINE(89)
...
{
		HX_STACK_PUSH("Main::initialise","Main.hx",58);
		HX_STACK_THIS(this);
		HX_STACK_ARG(ev,"ev");
		HX_STACK_LINE(60)
		...
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( ){
				HX_STACK_PUSH("*::closure","Main.hx",71);
				{
					HX_STACK_LINE(71)
					{
					}
