...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceNames.set ("assets/8ball.png", "assets/8ball.png");
			resourceTypes.set ("assets/8ball.png", "image");
			resourceNames.set ("assets/banaan.png", "assets/banaan.png");
			...
			resourceNames.set ("assets/pikachu.png", "assets/pikachu.png");
			resourceTypes.set ("assets/pikachu.png", "image");
			resourceNames.set ("assets/redleaf.png", "assets/redleaf.png");
			resourceTypes.set ("assets/redleaf.png", "image");
			resourceNames.set ("assets/rugby.png", "assets/rugby.png");
			resourceTypes.set ("assets/rugby.png", "image");
			resourceNames.set ("assets/tennisbal.png", "assets/tennisbal.png");
