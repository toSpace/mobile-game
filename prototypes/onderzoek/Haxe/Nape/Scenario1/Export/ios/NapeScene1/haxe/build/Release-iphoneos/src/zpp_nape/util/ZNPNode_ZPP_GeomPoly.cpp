...
{
HX_STACK_PUSH("ZNPNode_ZPP_GeomPoly::new","zpp_nape/util/Lists.hx",16190);
{
	HX_STACK_LINE(16224)
	this->elt = null();
	HX_STACK_LINE(16215)
...
::zpp_nape::geom::ZPP_GeomPoly ZNPNode_ZPP_GeomPoly_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_GeomPoly::elem","zpp_nape/util/Lists.hx",16228);
	HX_STACK_THIS(this);
	HX_STACK_LINE(16228)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_GeomPoly::free","zpp_nape/util/Lists.hx",16221);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16221)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_GeomPoly::alloc","zpp_nape/util/Lists.hx",16218);
		HX_STACK_THIS(this);
	}
return null();
}
