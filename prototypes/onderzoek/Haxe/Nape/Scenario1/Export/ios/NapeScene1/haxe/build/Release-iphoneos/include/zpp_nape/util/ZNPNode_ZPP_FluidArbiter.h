...
class ZNPNode_ZPP_FluidArbiter_obj : public hx::Object{
	public:
	...
	public:
		...
		::zpp_nape::dynamics::ZPP_FluidArbiter elt; /* REM */ 
		virtual Void free( );
		Dynamic free_dyn();
		...
		::zpp_nape::util::ZNPNode_ZPP_FluidArbiter next; /* REM */ 
		static ::zpp_nape::util::ZNPNode_ZPP_FluidArbiter zpp_pool; /* REM */ 
};
