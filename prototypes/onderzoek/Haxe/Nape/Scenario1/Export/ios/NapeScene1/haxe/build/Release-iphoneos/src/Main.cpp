...
{
		HX_STACK_PUSH("Main::updateGraphics","Main.hx",196);
		HX_STACK_THIS(this);
		HX_STACK_ARG(b,"b");
		struct _Function_1_1{
			inline static Dynamic Block( ::nape::phys::Body &b){
				HX_STACK_PUSH("*::closure","Main.hx",197);
				{
					HX_STACK_LINE(197)
		...
		struct _Function_1_2{
			inline static Float Block( ::nape::geom::Vec3 &pos){
				HX_STACK_PUSH("*::closure","Main.hx",200);
				{
					HX_STACK_LINE(200)
		...
		struct _Function_1_3{
			inline static Float Block( ::nape::geom::Vec3 &pos){
				HX_STACK_PUSH("*::closure","Main.hx",201);
				{
					HX_STACK_LINE(201)
					if (((bool((pos != null())) && bool(pos->zpp_disp)))){
						HX_STACK_LINE(201)
...
{
		HX_STACK_PUSH("Main::enterFrameHandler","Main.hx",173);
		HX_STACK_THIS(this);
		HX_STACK_ARG(ev,"ev");
		HX_STACK_LINE(175)
		...
		HX_STACK_LINE(188)
		{
			...
			struct _Function_2_1{
				inline static ::nape::phys::BodyIterator Block( ::nape::phys::BodyList &_this){
					HX_STACK_PUSH("*::closure","Main.hx",188);
					{
						HX_STACK_LINE(188)
		...
		HX_STACK_LINE(191)
		this->FPStext->set_text((((HX_CSTRING("FPS: ") + ::Std_obj::string(this->get_stage()->frameRate)) + HX_CSTRING("\nParticles: ")) + ::Std_obj::string(this->numObjs)));
	}
return null();
}
...
Dynamic Main_obj::getParticleType( ){
	HX_STACK_PUSH("Main::getParticleType","Main.hx",154);
	HX_STACK_THIS(this);
	HX_STACK_LINE(157)
...
{
		HX_STACK_PUSH("Main::addParticle","Main.hx",134);
		HX_STACK_THIS(this);
		HX_STACK_LINE(136)
		...
		HX_STACK_LINE(145)
		{
			struct _Function_2_1{
				inline static ::nape::geom::Vec2 Block( ::nape::phys::Body &Particle){
					HX_STACK_PUSH("*::closure","Main.hx",145);
					{
						HX_STACK_LINE(145)
...
{
		HX_STACK_PUSH("Main::createFloors","Main.hx",113);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_ARG(y,"y");
		...
		struct _Function_1_1{
			inline static ::nape::phys::BodyType Block( ){
				HX_STACK_PUSH("*::closure","Main.hx",116);
				{
					HX_STACK_LINE(116)
...
Void Main_obj::setUp( ){
{
		HX_STACK_PUSH("Main::setUp","Main.hx",90);
		HX_STACK_THIS(this);
		HX_STACK_LINE(90)
		...
		HX_STACK_LINE(102)
		this->FPStext = ::native::text::TextField_obj::__new();
		HX_STACK_LINE(103)
		this->FPStext->set_textColor((int)16777215);
		HX_STACK_LINE(104)
		this->FPStext->set_backgroundColor((int)0);
		HX_STACK_LINE(105)
		this->FPStext->set_background(true);
		HX_STACK_LINE(106)
		this->FPStext->set_x((int)0);
		HX_STACK_LINE(107)
		this->FPStext->set_y((int)0);
		HX_STACK_LINE(108)
		this->FPStext->set_width((int)65);
		HX_STACK_LINE(109)
		this->FPStext->set_height((int)30);
		HX_STACK_LINE(110)
...
{
		HX_STACK_PUSH("Main::initialise","Main.hx",62);
		HX_STACK_THIS(this);
		HX_STACK_ARG(ev,"ev");
		HX_STACK_LINE(64)
		...
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( ){
				HX_STACK_PUSH("*::closure","Main.hx",73);
				{
					HX_STACK_LINE(73)
					{
					}
...
void Main_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(numObjs,"numObjs");
	HX_MARK_MEMBER_NAME(FPStext,"FPStext");
...
void Main_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(numObjs,"numObjs");
	HX_VISIT_MEMBER_NAME(FPStext,"FPStext");
...
Dynamic Main_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 5:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"numObjs") ) { return numObjs; }
		if (HX_FIELD_EQ(inName,"FPStext") ) { return FPStext; }
		break;
	case 10:
...
Dynamic Main_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 5:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"numObjs") ) { numObjs=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"FPStext") ) { FPStext=inValue.Cast< ::native::text::TextField >(); return inValue; }
		break;
	case 17:
...
void Main_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_CSTRING("numObjs"));
	outFields->push(HX_CSTRING("FPStext"));
