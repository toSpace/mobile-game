...
class ZNPNode_ZPP_SimpleEvent_obj : public hx::Object{
	public:
	...
	public:
		...
		::zpp_nape::geom::ZPP_SimpleEvent elt; /* REM */ 
		virtual Void free( );
		Dynamic free_dyn();
		...
		::zpp_nape::util::ZNPNode_ZPP_SimpleEvent next; /* REM */ 
		static ::zpp_nape::util::ZNPNode_ZPP_SimpleEvent zpp_pool; /* REM */ 
};
