...
class ZNPNode_ZPP_Body_obj : public hx::Object{
	public:
	...
	public:
		...
		::zpp_nape::phys::ZPP_Body elt; /* REM */ 
		virtual Void free( );
		Dynamic free_dyn();
		...
		::zpp_nape::util::ZNPNode_ZPP_Body next; /* REM */ 
		static ::zpp_nape::util::ZNPNode_ZPP_Body zpp_pool; /* REM */ 
};
