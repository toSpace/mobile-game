...
class ZNPNode_ZPP_ToiEvent_obj : public hx::Object{
	public:
	...
	public:
		...
		::zpp_nape::geom::ZPP_ToiEvent elt; /* REM */ 
		virtual Void free( );
		Dynamic free_dyn();
		...
		::zpp_nape::util::ZNPNode_ZPP_ToiEvent next; /* REM */ 
		static ::zpp_nape::util::ZNPNode_ZPP_ToiEvent zpp_pool; /* REM */ 
};
