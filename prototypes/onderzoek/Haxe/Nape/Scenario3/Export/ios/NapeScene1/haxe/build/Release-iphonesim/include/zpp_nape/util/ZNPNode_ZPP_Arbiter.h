...
class ZNPNode_ZPP_Arbiter_obj : public hx::Object{
	public:
	...
	public:
		...
		::zpp_nape::dynamics::ZPP_Arbiter elt; /* REM */ 
		virtual Void free( );
		Dynamic free_dyn();
		...
		::zpp_nape::util::ZNPNode_ZPP_Arbiter next; /* REM */ 
		static ::zpp_nape::util::ZNPNode_ZPP_Arbiter zpp_pool; /* REM */ 
};
