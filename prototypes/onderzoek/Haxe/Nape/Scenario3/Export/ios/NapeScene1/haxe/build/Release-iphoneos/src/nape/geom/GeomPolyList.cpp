...
{
HX_STACK_PUSH("GeomPolyList::new","nape/geom/GeomPolyList.hx",234);
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
...
::nape::geom::GeomPolyList GeomPolyList_obj::filter( Dynamic lambda){
	HX_STACK_PUSH("GeomPolyList::filter","nape/geom/GeomPolyList.hx",779);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::geom::GeomPolyList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/geom/GeomPolyList.hx",784);
			{
				HX_STACK_LINE(784)
...
::nape::geom::GeomPolyList GeomPolyList_obj::foreach( Dynamic lambda){
	HX_STACK_PUSH("GeomPolyList::foreach","nape/geom/GeomPolyList.hx",732);
	HX_STACK_THIS(this);
	HX_STACK_ARG(lambda,"lambda");
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static ::nape::geom::GeomPolyIterator Block( ::nape::geom::GeomPolyList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/geom/GeomPolyList.hx",736);
			{
				HX_STACK_LINE(736)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(736)
	...
	HX_STACK_LINE(736)
	::nape::geom::GeomPolyIterator it = _Function_1_1::Block(this);		HX_STACK_VAR(it,"it");
	struct _Function_1_2{
		inline static bool Block( ::nape::geom::GeomPolyIterator &it){
			HX_STACK_PUSH("*::closure","nape/geom/GeomPolyList.hx",737);
			{
				HX_STACK_LINE(737)
				it->zpp_inner->zpp_inner->valmod();
				struct _Function_2_1{
					inline static int Block( ::nape::geom::GeomPolyIterator &it){
						HX_STACK_PUSH("*::closure","nape/geom/GeomPolyList.hx",737);
						{
							HX_STACK_LINE(737)
		...
		try{
			struct _Function_3_1{
				inline static ::nape::geom::GeomPoly Block( ::nape::geom::GeomPolyIterator &it){
					HX_STACK_PUSH("*::closure","nape/geom/GeomPolyList.hx",739);
					{
						HX_STACK_LINE(739)
...
::String GeomPolyList_obj::toString( ){
	HX_STACK_PUSH("GeomPolyList::toString","nape/geom/GeomPolyList.hx",702);
	HX_STACK_THIS(this);
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::geom::GeomPolyIterator Block( ::nape::geom::GeomPolyList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/geom/GeomPolyList.hx",705);
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
...
{
		HX_STACK_PUSH("GeomPolyList::merge","nape/geom/GeomPolyList.hx",684);
		HX_STACK_THIS(this);
		HX_STACK_ARG(xs,"xs");
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::geom::GeomPolyIterator Block( ::nape::geom::GeomPolyList &xs){
				HX_STACK_PUSH("*::closure","nape/geom/GeomPolyList.hx",688);
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
...
bool deep = __o_deep.Default(false);
	HX_STACK_PUSH("GeomPolyList::copy","nape/geom/GeomPolyList.hx",662);
	HX_STACK_THIS(this);
	HX_STACK_ARG(deep,"deep");
{
		...
		struct _Function_1_1{
			inline static ::nape::geom::GeomPolyIterator Block( ::nape::geom::GeomPolyList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/geom/GeomPolyList.hx",664);
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::geom::GeomPoly Block( ){
				...
				{
					HX_STACK_LINE(666)
					hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("GeomPoly")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
...
::nape::geom::GeomPolyIterator GeomPolyList_obj::iterator( ){
	HX_STACK_PUSH("GeomPolyList::iterator","nape/geom/GeomPolyList.hx",647);
	HX_STACK_THIS(this);
	HX_STACK_LINE(648)
...
bool GeomPolyList_obj::empty( ){
	HX_STACK_PUSH("GeomPolyList::empty","nape/geom/GeomPolyList.hx",631);
	HX_STACK_THIS(this);
	HX_STACK_LINE(631)
...
{
		HX_STACK_PUSH("GeomPolyList::clear","nape/geom/GeomPolyList.hx",614);
		HX_STACK_THIS(this);
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("GeomPoly")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(618)
...
bool GeomPolyList_obj::remove( ::nape::geom::GeomPoly obj){
	HX_STACK_PUSH("GeomPolyList::remove","nape/geom/GeomPolyList.hx",576);
	HX_STACK_THIS(this);
...
bool GeomPolyList_obj::add( ::nape::geom::GeomPoly obj){
	HX_STACK_PUSH("GeomPolyList::add","nape/geom/GeomPolyList.hx",563);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(563)
...
::nape::geom::GeomPoly GeomPolyList_obj::shift( ){
	HX_STACK_PUSH("GeomPolyList::shift","nape/geom/GeomPolyList.hx",519);
	HX_STACK_THIS(this);
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::geom::GeomPolyList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/geom/GeomPolyList.hx",533);
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
		...
		HX_STACK_LINE(533)
		::zpp_nape::util::ZNPNode_ZPP_GeomPoly ite = (  (((_Function_2_1::Block(this) == (int)1))) ? ::zpp_nape::util::ZNPNode_ZPP_GeomPoly(null()) : ::zpp_nape::util::ZNPNode_ZPP_GeomPoly(this->zpp_inner->inner->iterator_at((_Function_2_2::Block(this) - (int)2))) );		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(534)
		ret = (  (((ite == null()))) ? ::zpp_nape::geom::ZPP_GeomPoly(this->zpp_inner->inner->head->elt) : ::zpp_nape::geom::ZPP_GeomPoly(ite->next->elt) );
		HX_STACK_LINE(535)
...
::nape::geom::GeomPoly GeomPolyList_obj::pop( ){
	HX_STACK_PUSH("GeomPolyList::pop","nape/geom/GeomPolyList.hx",478);
	HX_STACK_THIS(this);
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::geom::GeomPolyList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/geom/GeomPolyList.hx",498);
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool GeomPolyList_obj::unshift( ::nape::geom::GeomPoly obj){
	HX_STACK_PUSH("GeomPolyList::unshift","nape/geom/GeomPolyList.hx",447);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::geom::GeomPolyList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/geom/GeomPolyList.hx",458);
						{
							HX_STACK_LINE(458)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(458)
				...
				HX_STACK_LINE(458)
				this->zpp_inner->push_ite = (  (((this->zpp_inner->inner->head == null()))) ? ::zpp_nape::util::ZNPNode_ZPP_GeomPoly(null()) : ::zpp_nape::util::ZNPNode_ZPP_GeomPoly(this->zpp_inner->inner->iterator_at((_Function_4_1::Block(this) - (int)1))) );
			}
			HX_STACK_LINE(459)
...
bool GeomPolyList_obj::push( ::nape::geom::GeomPoly obj){
	HX_STACK_PUSH("GeomPolyList::push","nape/geom/GeomPolyList.hx",416);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
	...
	if ((cont)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::geom::GeomPolyList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/geom/GeomPolyList.hx",428);
						{
							HX_STACK_LINE(428)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(428)
...
::nape::geom::GeomPoly GeomPolyList_obj::at( int index){
	HX_STACK_PUSH("GeomPolyList::at","nape/geom/GeomPolyList.hx",363);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::geom::GeomPolyList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/geom/GeomPolyList.hx",368);
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::geom::GeomPolyList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/geom/GeomPolyList.hx",370);
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool GeomPolyList_obj::has( ::nape::geom::GeomPoly obj){
	HX_STACK_PUSH("GeomPolyList::has","nape/geom/GeomPolyList.hx",346);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int GeomPolyList_obj::get_length( ){
	HX_STACK_PUSH("GeomPolyList::get_length","nape/geom/GeomPolyList.hx",244);
	HX_STACK_THIS(this);
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::geom::GeomPolyList GeomPolyList_obj::fromArray( Array< ::nape::geom::GeomPoly > array){
	HX_STACK_PUSH("GeomPolyList::fromArray","nape/geom/GeomPolyList.hx",304);
	...
	HX_STACK_LINE(311)
	{
		...
		while(((_g < array->length))){
			HX_STACK_LINE(311)
			::nape::geom::GeomPoly i = array->__get(_g);		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			ret->push(i);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("nape.geom.GeomPolyList"), hx::TCanCast< GeomPolyList_obj> ,sStaticFields,sMemberFields,
