...
class ConstraintList_obj : public hx::Object{
	public:
	...
	public:
		...
		int length; /* REM */ 
		::zpp_nape::util::ZPP_ConstraintList zpp_inner; /* REM */ 
		static ::nape::constraint::ConstraintList fromArray( Array< ::nape::constraint::Constraint > array);
