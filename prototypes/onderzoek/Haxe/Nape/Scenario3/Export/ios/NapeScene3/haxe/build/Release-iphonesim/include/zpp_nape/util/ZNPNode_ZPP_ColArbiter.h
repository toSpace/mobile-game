...
class ZNPNode_ZPP_ColArbiter_obj : public hx::Object{
	public:
	...
	public:
		...
		::zpp_nape::dynamics::ZPP_ColArbiter elt; /* REM */ 
		virtual Void free( );
		Dynamic free_dyn();
		...
		::zpp_nape::util::ZNPNode_ZPP_ColArbiter next; /* REM */ 
		static ::zpp_nape::util::ZNPNode_ZPP_ColArbiter zpp_pool; /* REM */ 
};
