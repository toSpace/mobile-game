...
class ZNPNode_ZPP_CallbackSet_obj : public hx::Object{
	public:
	...
	public:
		...
		::zpp_nape::space::ZPP_CallbackSet elt; /* REM */ 
		virtual Void free( );
		Dynamic free_dyn();
		...
		::zpp_nape::util::ZNPNode_ZPP_CallbackSet next; /* REM */ 
		static ::zpp_nape::util::ZNPNode_ZPP_CallbackSet zpp_pool; /* REM */ 
};
