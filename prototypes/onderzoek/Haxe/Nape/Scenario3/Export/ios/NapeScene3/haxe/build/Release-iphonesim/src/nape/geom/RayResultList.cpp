...
{
HX_STACK_PUSH("RayResultList::new","nape/geom/RayResultList.hx",234);
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
...
::nape::geom::RayResultList RayResultList_obj::filter( Dynamic lambda){
	HX_STACK_PUSH("RayResultList::filter","nape/geom/RayResultList.hx",779);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::geom::RayResultList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/geom/RayResultList.hx",784);
			{
				HX_STACK_LINE(784)
...
::nape::geom::RayResultList RayResultList_obj::foreach( Dynamic lambda){
	HX_STACK_PUSH("RayResultList::foreach","nape/geom/RayResultList.hx",732);
	HX_STACK_THIS(this);
	HX_STACK_ARG(lambda,"lambda");
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static ::nape::geom::RayResultIterator Block( ::nape::geom::RayResultList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/geom/RayResultList.hx",736);
			{
				HX_STACK_LINE(736)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(736)
	...
	HX_STACK_LINE(736)
	::nape::geom::RayResultIterator it = _Function_1_1::Block(this);		HX_STACK_VAR(it,"it");
	struct _Function_1_2{
		inline static bool Block( ::nape::geom::RayResultIterator &it){
			HX_STACK_PUSH("*::closure","nape/geom/RayResultList.hx",737);
			{
				HX_STACK_LINE(737)
				it->zpp_inner->zpp_inner->valmod();
				struct _Function_2_1{
					inline static int Block( ::nape::geom::RayResultIterator &it){
						HX_STACK_PUSH("*::closure","nape/geom/RayResultList.hx",737);
						{
							HX_STACK_LINE(737)
		...
		try{
			struct _Function_3_1{
				inline static ::nape::geom::RayResult Block( ::nape::geom::RayResultIterator &it){
					HX_STACK_PUSH("*::closure","nape/geom/RayResultList.hx",739);
					{
						HX_STACK_LINE(739)
...
::String RayResultList_obj::toString( ){
	HX_STACK_PUSH("RayResultList::toString","nape/geom/RayResultList.hx",702);
	HX_STACK_THIS(this);
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::geom::RayResultIterator Block( ::nape::geom::RayResultList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/geom/RayResultList.hx",705);
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
...
{
		HX_STACK_PUSH("RayResultList::merge","nape/geom/RayResultList.hx",684);
		HX_STACK_THIS(this);
		HX_STACK_ARG(xs,"xs");
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::geom::RayResultIterator Block( ::nape::geom::RayResultList &xs){
				HX_STACK_PUSH("*::closure","nape/geom/RayResultList.hx",688);
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
...
bool deep = __o_deep.Default(false);
	HX_STACK_PUSH("RayResultList::copy","nape/geom/RayResultList.hx",662);
	HX_STACK_THIS(this);
	HX_STACK_ARG(deep,"deep");
{
		...
		struct _Function_1_1{
			inline static ::nape::geom::RayResultIterator Block( ::nape::geom::RayResultList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/geom/RayResultList.hx",664);
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::geom::RayResult Block( ){
				...
				{
					HX_STACK_LINE(666)
					hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("RayResult")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
...
::nape::geom::RayResultIterator RayResultList_obj::iterator( ){
	HX_STACK_PUSH("RayResultList::iterator","nape/geom/RayResultList.hx",647);
	HX_STACK_THIS(this);
	HX_STACK_LINE(648)
...
bool RayResultList_obj::empty( ){
	HX_STACK_PUSH("RayResultList::empty","nape/geom/RayResultList.hx",631);
	HX_STACK_THIS(this);
	HX_STACK_LINE(631)
...
{
		HX_STACK_PUSH("RayResultList::clear","nape/geom/RayResultList.hx",614);
		HX_STACK_THIS(this);
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("RayResult")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(618)
...
bool RayResultList_obj::remove( ::nape::geom::RayResult obj){
	HX_STACK_PUSH("RayResultList::remove","nape/geom/RayResultList.hx",576);
	HX_STACK_THIS(this);
...
bool RayResultList_obj::add( ::nape::geom::RayResult obj){
	HX_STACK_PUSH("RayResultList::add","nape/geom/RayResultList.hx",563);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(563)
...
::nape::geom::RayResult RayResultList_obj::shift( ){
	HX_STACK_PUSH("RayResultList::shift","nape/geom/RayResultList.hx",519);
	HX_STACK_THIS(this);
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::geom::RayResultList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/geom/RayResultList.hx",533);
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
		...
		HX_STACK_LINE(533)
		::zpp_nape::util::ZNPNode_RayResult ite = (  (((_Function_2_1::Block(this) == (int)1))) ? ::zpp_nape::util::ZNPNode_RayResult(null()) : ::zpp_nape::util::ZNPNode_RayResult(this->zpp_inner->inner->iterator_at((_Function_2_2::Block(this) - (int)2))) );		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(534)
		ret = (  (((ite == null()))) ? ::nape::geom::RayResult(this->zpp_inner->inner->head->elt) : ::nape::geom::RayResult(ite->next->elt) );
		HX_STACK_LINE(535)
...
::nape::geom::RayResult RayResultList_obj::pop( ){
	HX_STACK_PUSH("RayResultList::pop","nape/geom/RayResultList.hx",478);
	HX_STACK_THIS(this);
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::geom::RayResultList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/geom/RayResultList.hx",498);
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool RayResultList_obj::unshift( ::nape::geom::RayResult obj){
	HX_STACK_PUSH("RayResultList::unshift","nape/geom/RayResultList.hx",447);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::geom::RayResultList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/geom/RayResultList.hx",458);
						{
							HX_STACK_LINE(458)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(458)
				...
				HX_STACK_LINE(458)
				this->zpp_inner->push_ite = (  (((this->zpp_inner->inner->head == null()))) ? ::zpp_nape::util::ZNPNode_RayResult(null()) : ::zpp_nape::util::ZNPNode_RayResult(this->zpp_inner->inner->iterator_at((_Function_4_1::Block(this) - (int)1))) );
			}
			HX_STACK_LINE(459)
...
bool RayResultList_obj::push( ::nape::geom::RayResult obj){
	HX_STACK_PUSH("RayResultList::push","nape/geom/RayResultList.hx",416);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
	...
	if ((cont)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::geom::RayResultList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/geom/RayResultList.hx",428);
						{
							HX_STACK_LINE(428)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(428)
...
::nape::geom::RayResult RayResultList_obj::at( int index){
	HX_STACK_PUSH("RayResultList::at","nape/geom/RayResultList.hx",363);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::geom::RayResultList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/geom/RayResultList.hx",368);
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::geom::RayResultList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/geom/RayResultList.hx",370);
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool RayResultList_obj::has( ::nape::geom::RayResult obj){
	HX_STACK_PUSH("RayResultList::has","nape/geom/RayResultList.hx",346);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int RayResultList_obj::get_length( ){
	HX_STACK_PUSH("RayResultList::get_length","nape/geom/RayResultList.hx",244);
	HX_STACK_THIS(this);
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::geom::RayResultList RayResultList_obj::fromArray( Array< ::nape::geom::RayResult > array){
	HX_STACK_PUSH("RayResultList::fromArray","nape/geom/RayResultList.hx",304);
	...
	HX_STACK_LINE(311)
	{
		...
		while(((_g < array->length))){
			HX_STACK_LINE(311)
			::nape::geom::RayResult i = array->__get(_g);		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			ret->push(i);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("nape.geom.RayResultList"), hx::TCanCast< RayResultList_obj> ,sStaticFields,sMemberFields,
