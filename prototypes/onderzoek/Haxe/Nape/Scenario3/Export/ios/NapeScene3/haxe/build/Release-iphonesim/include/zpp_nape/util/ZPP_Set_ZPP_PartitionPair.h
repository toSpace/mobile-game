...
class ZPP_Set_ZPP_PartitionPair_obj : public hx::Object{
	public:
	...
	public:
		...
		int colour; /* REM */ 
		::zpp_nape::util::ZPP_Set_ZPP_PartitionPair parent; /* REM */ 
		::zpp_nape::util::ZPP_Set_ZPP_PartitionPair next; /* REM */ 
		::zpp_nape::util::ZPP_Set_ZPP_PartitionPair prev; /* REM */ 
		::zpp_nape::geom::ZPP_PartitionPair data; /* REM */ 
		Dynamic swapped; /* REM */ 
		...
		static ::zpp_nape::util::ZPP_Set_ZPP_PartitionPair zpp_pool; /* REM */ 
};
