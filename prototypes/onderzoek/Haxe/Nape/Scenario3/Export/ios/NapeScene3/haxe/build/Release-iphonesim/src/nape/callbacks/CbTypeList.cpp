...
::nape::callbacks::CbTypeList CbTypeList_obj::fromArray( Array< ::nape::callbacks::CbType > array){
	...
	HX_STACK_LINE(311)
	{
		...
		while(((_g < array->length))){
			HX_STACK_LINE(311)
			::nape::callbacks::CbType i = array->__get(_g);		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			ret->push(i);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("nape.callbacks.CbTypeList"), hx::TCanCast< CbTypeList_obj> ,sStaticFields,sMemberFields,
