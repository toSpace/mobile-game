...
{
HX_STACK_PUSH("ZNPNode_ZPP_SimpleVert::new","zpp_nape/util/Lists.hx",15588);
{
	HX_STACK_LINE(15622)
	this->elt = null();
	HX_STACK_LINE(15613)
...
::zpp_nape::geom::ZPP_SimpleVert ZNPNode_ZPP_SimpleVert_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_SimpleVert::elem","zpp_nape/util/Lists.hx",15626);
	HX_STACK_THIS(this);
	HX_STACK_LINE(15626)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_SimpleVert::free","zpp_nape/util/Lists.hx",15619);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15619)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_SimpleVert::alloc","zpp_nape/util/Lists.hx",15616);
		HX_STACK_THIS(this);
	}
return null();
}
