...
{
HX_STACK_PUSH("ZNPNode_ZPP_Vec2::new","zpp_nape/util/Lists.hx",15674);
{
	HX_STACK_LINE(15708)
	this->elt = null();
	HX_STACK_LINE(15699)
...
::zpp_nape::geom::ZPP_Vec2 ZNPNode_ZPP_Vec2_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_Vec2::elem","zpp_nape/util/Lists.hx",15712);
	HX_STACK_THIS(this);
	HX_STACK_LINE(15712)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Vec2::free","zpp_nape/util/Lists.hx",15705);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15705)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Vec2::alloc","zpp_nape/util/Lists.hx",15702);
		HX_STACK_THIS(this);
	}
return null();
}
