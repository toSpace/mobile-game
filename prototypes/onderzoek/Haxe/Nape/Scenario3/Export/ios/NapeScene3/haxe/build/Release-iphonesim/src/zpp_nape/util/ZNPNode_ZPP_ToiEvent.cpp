...
{
HX_STACK_PUSH("ZNPNode_ZPP_ToiEvent::new","zpp_nape/util/Lists.hx",16061);
{
	HX_STACK_LINE(16095)
	this->elt = null();
	HX_STACK_LINE(16086)
...
::zpp_nape::geom::ZPP_ToiEvent ZNPNode_ZPP_ToiEvent_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_ToiEvent::elem","zpp_nape/util/Lists.hx",16099);
	HX_STACK_THIS(this);
	HX_STACK_LINE(16099)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_ToiEvent::free","zpp_nape/util/Lists.hx",16092);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16092)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_ToiEvent::alloc","zpp_nape/util/Lists.hx",16089);
		HX_STACK_THIS(this);
	}
return null();
}
