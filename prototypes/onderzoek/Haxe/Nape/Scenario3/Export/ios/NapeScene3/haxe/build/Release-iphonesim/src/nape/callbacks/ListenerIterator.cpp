...
{
HX_STACK_PUSH("ListenerIterator::new","nape/callbacks/ListenerIterator.hx",178);
{
	HX_STACK_LINE(198)
	this->zpp_next = null();
	HX_STACK_LINE(190)
	...
	if ((!(::zpp_nape::util::ZPP_ListenerList_obj::internal))){
		HX_STACK_LINE(204)
		hx::Throw (((HX_CSTRING("Error: Cannot instantiate ") + HX_CSTRING("Listener")) + HX_CSTRING("Iterator derp!")));
	}
}
;
	return null();
...
::nape::callbacks::Listener ListenerIterator_obj::next( ){
	HX_STACK_PUSH("ListenerIterator::next","nape/callbacks/ListenerIterator.hx",264);
	HX_STACK_THIS(this);
	HX_STACK_LINE(265)
	this->zpp_critical = false;
	HX_STACK_LINE(266)
...
bool ListenerIterator_obj::hasNext( ){
	HX_STACK_PUSH("ListenerIterator::hasNext","nape/callbacks/ListenerIterator.hx",240);
	HX_STACK_THIS(this);
	HX_STACK_LINE(241)
	this->zpp_inner->zpp_inner->valmod();
	struct _Function_1_1{
		inline static int Block( ::nape::callbacks::ListenerIterator_obj *__this){
			HX_STACK_PUSH("*::closure","nape/callbacks/ListenerIterator.hx",244);
			{
				HX_STACK_LINE(244)
				::nape::callbacks::ListenerList _this = __this->zpp_inner;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(244)
...
::nape::callbacks::ListenerIterator ListenerIterator_obj::get( ::nape::callbacks::ListenerList list){
	HX_STACK_PUSH("ListenerIterator::get","nape/callbacks/ListenerIterator.hx",217);
	HX_STACK_ARG(list,"list");
	struct _Function_1_1{
		inline static ::nape::callbacks::ListenerIterator Block( ){
			HX_STACK_PUSH("*::closure","nape/callbacks/ListenerIterator.hx",218);
			{
				HX_STACK_LINE(219)
	...
	struct _Function_1_2{
		inline static ::nape::callbacks::ListenerIterator Block( ){
			HX_STACK_PUSH("*::closure","nape/callbacks/ListenerIterator.hx",224);
			{
				HX_STACK_LINE(225)
	...
	HX_STACK_LINE(218)
	::nape::callbacks::ListenerIterator ret = (  (((::nape::callbacks::ListenerIterator_obj::zpp_pool == null()))) ? ::nape::callbacks::ListenerIterator(_Function_1_1::Block()) : ::nape::callbacks::ListenerIterator(_Function_1_2::Block()) );		HX_STACK_VAR(ret,"ret");
	HX_STACK_LINE(229)
	ret->zpp_i = (int)0;
	HX_STACK_LINE(230)
	ret->zpp_inner = list;
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("nape.callbacks.ListenerIterator"), hx::TCanCast< ListenerIterator_obj> ,sStaticFields,sMemberFields,
