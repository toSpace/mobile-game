...
class ZNPNode_ZPP_Vec2_obj : public hx::Object{
	public:
	...
	public:
		...
		::zpp_nape::geom::ZPP_Vec2 elt; /* REM */ 
		virtual Void free( );
		Dynamic free_dyn();
		...
		::zpp_nape::util::ZNPNode_ZPP_Vec2 next; /* REM */ 
		static ::zpp_nape::util::ZNPNode_ZPP_Vec2 zpp_pool; /* REM */ 
};
