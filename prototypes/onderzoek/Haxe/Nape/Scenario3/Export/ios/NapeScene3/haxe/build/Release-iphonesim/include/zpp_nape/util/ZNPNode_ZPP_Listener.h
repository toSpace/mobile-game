...
class ZNPNode_ZPP_Listener_obj : public hx::Object{
	public:
	...
	public:
		...
		::zpp_nape::callbacks::ZPP_Listener elt; /* REM */ 
		virtual Void free( );
		Dynamic free_dyn();
		...
		::zpp_nape::util::ZNPNode_ZPP_Listener next; /* REM */ 
		static ::zpp_nape::util::ZNPNode_ZPP_Listener zpp_pool; /* REM */ 
};
