...
{
HX_STACK_PUSH("ZNPNode_ZPP_ColArbiter::new","zpp_nape/util/Lists.hx",16018);
{
	HX_STACK_LINE(16052)
	this->elt = null();
	HX_STACK_LINE(16043)
...
::zpp_nape::dynamics::ZPP_ColArbiter ZNPNode_ZPP_ColArbiter_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_ColArbiter::elem","zpp_nape/util/Lists.hx",16056);
	HX_STACK_THIS(this);
	HX_STACK_LINE(16056)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_ColArbiter::free","zpp_nape/util/Lists.hx",16049);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16049)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_ColArbiter::alloc","zpp_nape/util/Lists.hx",16046);
		HX_STACK_THIS(this);
	}
return null();
}
