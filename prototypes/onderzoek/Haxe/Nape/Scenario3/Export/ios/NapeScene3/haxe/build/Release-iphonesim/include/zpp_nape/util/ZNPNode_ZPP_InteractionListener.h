...
class ZNPNode_ZPP_InteractionListener_obj : public hx::Object{
	public:
	...
	public:
		...
		::zpp_nape::callbacks::ZPP_InteractionListener elt; /* REM */ 
		virtual Void free( );
		Dynamic free_dyn();
		...
		::zpp_nape::util::ZNPNode_ZPP_InteractionListener next; /* REM */ 
		static ::zpp_nape::util::ZNPNode_ZPP_InteractionListener zpp_pool; /* REM */ 
};
