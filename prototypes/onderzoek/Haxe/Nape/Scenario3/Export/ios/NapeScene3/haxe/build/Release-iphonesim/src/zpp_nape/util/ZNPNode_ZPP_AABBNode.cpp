...
{
HX_STACK_PUSH("ZNPNode_ZPP_AABBNode::new","zpp_nape/util/Lists.hx",15803);
{
	HX_STACK_LINE(15837)
	this->elt = null();
	HX_STACK_LINE(15828)
...
::zpp_nape::space::ZPP_AABBNode ZNPNode_ZPP_AABBNode_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_AABBNode::elem","zpp_nape/util/Lists.hx",15841);
	HX_STACK_THIS(this);
	HX_STACK_LINE(15841)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_AABBNode::free","zpp_nape/util/Lists.hx",15834);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15834)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_AABBNode::alloc","zpp_nape/util/Lists.hx",15831);
		HX_STACK_THIS(this);
	}
return null();
}
