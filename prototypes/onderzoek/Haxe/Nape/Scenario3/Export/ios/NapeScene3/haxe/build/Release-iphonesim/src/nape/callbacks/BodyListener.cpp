...
{
HX_STACK_PUSH("BodyListener::new","nape/callbacks/BodyListener.hx",180);
int precedence = __o_precedence.Default(0);
{
	...
	if (((handler == null()))){
		HX_STACK_LINE(257)
		hx::Throw (HX_CSTRING("Error: BodyListener::handler cannot be null"));
	}
	HX_STACK_LINE(261)
	int xevent = (int)-1;		HX_STACK_VAR(xevent,"xevent");
	struct _Function_1_1{
		inline static ::nape::callbacks::CbEvent Block( ){
			HX_STACK_PUSH("*::closure","nape/callbacks/BodyListener.hx",262);
			{
				HX_STACK_LINE(262)
	...
	if (((event == _Function_1_1::Block()))){
		...
		struct _Function_2_1{
			inline static ::nape::callbacks::CbEvent Block( ){
				HX_STACK_PUSH("*::closure","nape/callbacks/BodyListener.hx",263);
				{
					HX_STACK_LINE(263)
		...
		if (((event == _Function_2_1::Block()))){
			...
			HX_STACK_LINE(264)
			hx::Throw (((HX_CSTRING("Error: cbEvent '") + event->toString()) + HX_CSTRING("' is not a valid event type for a BodyListener")));
		}
	}
	HX_STACK_LINE(269)
...
Dynamic BodyListener_obj::set_handler( Dynamic handler){
	HX_STACK_PUSH("BodyListener::set_handler","nape/callbacks/BodyListener.hx",211);
	HX_STACK_THIS(this);
...
::nape::callbacks::OptionType BodyListener_obj::set_options( ::nape::callbacks::OptionType options){
	HX_STACK_PUSH("BodyListener::set_options","nape/callbacks/BodyListener.hx",197);
	HX_STACK_THIS(this);
...
::nape::callbacks::OptionType BodyListener_obj::get_options( ){
	HX_STACK_PUSH("BodyListener::get_options","nape/callbacks/BodyListener.hx",194);
	HX_STACK_THIS(this);
	HX_STACK_LINE(194)
	return this->zpp_inner_zn->options->outer;
}
