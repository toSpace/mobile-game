...
class InteractionGroupList_obj : public hx::Object{
	public:
	...
	public:
		...
		int length; /* REM */ 
		::zpp_nape::util::ZPP_InteractionGroupList zpp_inner; /* REM */ 
		static ::nape::dynamics::InteractionGroupList fromArray( Array< ::nape::dynamics::InteractionGroup > array);
