...
{
HX_STACK_PUSH("BodyList::new","nape/phys/BodyList.hx",234);
{
	HX_STACK_LINE(238)
	this->zpp_inner = null();
	HX_STACK_LINE(696)
...
::nape::phys::BodyList BodyList_obj::filter( Dynamic lambda){
	HX_STACK_PUSH("BodyList::filter","nape/phys/BodyList.hx",779);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::phys::BodyList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/phys/BodyList.hx",784);
			{
				HX_STACK_LINE(784)
...
::nape::phys::BodyList BodyList_obj::foreach( Dynamic lambda){
	HX_STACK_PUSH("BodyList::foreach","nape/phys/BodyList.hx",732);
	HX_STACK_THIS(this);
	HX_STACK_ARG(lambda,"lambda");
	HX_STACK_LINE(734)
	if (((lambda == null()))){
	...
	struct _Function_1_1{
		inline static ::nape::phys::BodyIterator Block( ::nape::phys::BodyList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/phys/BodyList.hx",736);
			{
				HX_STACK_LINE(736)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(736)
	...
	HX_STACK_LINE(736)
	::nape::phys::BodyIterator it = _Function_1_1::Block(this);		HX_STACK_VAR(it,"it");
	struct _Function_1_2{
		inline static bool Block( ::nape::phys::BodyIterator &it){
			HX_STACK_PUSH("*::closure","nape/phys/BodyList.hx",737);
			{
				HX_STACK_LINE(737)
		...
		try{
			struct _Function_3_1{
				inline static ::nape::phys::Body Block( ::nape::phys::BodyIterator &it){
					HX_STACK_PUSH("*::closure","nape/phys/BodyList.hx",739);
					{
						HX_STACK_LINE(739)
...
::String BodyList_obj::toString( ){
	HX_STACK_PUSH("BodyList::toString","nape/phys/BodyList.hx",702);
	HX_STACK_THIS(this);
	HX_STACK_LINE(703)
	...
	struct _Function_1_1{
		inline static ::nape::phys::BodyIterator Block( ::nape::phys::BodyList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/phys/BodyList.hx",705);
			{
				HX_STACK_LINE(705)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(705)
...
{
		HX_STACK_PUSH("BodyList::merge","nape/phys/BodyList.hx",684);
		HX_STACK_THIS(this);
		HX_STACK_ARG(xs,"xs");
		HX_STACK_LINE(686)
		if (((xs == null()))){
		...
		struct _Function_1_1{
			inline static ::nape::phys::BodyIterator Block( ::nape::phys::BodyList &xs){
				HX_STACK_PUSH("*::closure","nape/phys/BodyList.hx",688);
				{
					HX_STACK_LINE(688)
					xs->zpp_inner->valmod();
					HX_STACK_LINE(688)
...
bool deep = __o_deep.Default(false);
	HX_STACK_PUSH("BodyList::copy","nape/phys/BodyList.hx",662);
	HX_STACK_THIS(this);
	HX_STACK_ARG(deep,"deep");
{
		...
		struct _Function_1_1{
			inline static ::nape::phys::BodyIterator Block( ::nape::phys::BodyList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/phys/BodyList.hx",664);
				{
					HX_STACK_LINE(664)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(664)
		...
		struct _Function_1_2{
			inline static ::nape::phys::Body Block( ){
				...
				{
					HX_STACK_LINE(666)
					hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("Body")) + HX_CSTRING(" is not a copyable type")));
					HX_STACK_LINE(668)
					return null();
				}
				return null();
...
::nape::phys::BodyIterator BodyList_obj::iterator( ){
	HX_STACK_PUSH("BodyList::iterator","nape/phys/BodyList.hx",647);
	HX_STACK_THIS(this);
	HX_STACK_LINE(648)
...
bool BodyList_obj::empty( ){
	HX_STACK_PUSH("BodyList::empty","nape/phys/BodyList.hx",631);
	HX_STACK_THIS(this);
	HX_STACK_LINE(631)
...
{
		HX_STACK_PUSH("BodyList::clear","nape/phys/BodyList.hx",614);
		HX_STACK_THIS(this);
		HX_STACK_LINE(616)
		if ((this->zpp_inner->immutable)){
			HX_STACK_LINE(616)
			hx::Throw (((HX_CSTRING("Error: ") + HX_CSTRING("Body")) + HX_CSTRING("List is immutable")));
		}
		HX_STACK_LINE(618)
		if ((this->zpp_inner->reverse_flag)){
			HX_STACK_LINE(618)
...
bool BodyList_obj::remove( ::nape::phys::Body obj){
	HX_STACK_PUSH("BodyList::remove","nape/phys/BodyList.hx",576);
	HX_STACK_THIS(this);
...
bool BodyList_obj::add( ::nape::phys::Body obj){
	HX_STACK_PUSH("BodyList::add","nape/phys/BodyList.hx",563);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(563)
...
::nape::phys::Body BodyList_obj::shift( ){
	HX_STACK_PUSH("BodyList::shift","nape/phys/BodyList.hx",519);
	HX_STACK_THIS(this);
	HX_STACK_LINE(521)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(521)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::phys::BodyList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/phys/BodyList.hx",533);
				{
					HX_STACK_LINE(533)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(533)
		...
		HX_STACK_LINE(533)
		::zpp_nape::util::ZNPNode_ZPP_Body ite = (  (((_Function_2_1::Block(this) == (int)1))) ? ::zpp_nape::util::ZNPNode_ZPP_Body(null()) : ::zpp_nape::util::ZNPNode_ZPP_Body(this->zpp_inner->inner->iterator_at((_Function_2_2::Block(this) - (int)2))) );		HX_STACK_VAR(ite,"ite");
		HX_STACK_LINE(534)
		ret = (  (((ite == null()))) ? ::zpp_nape::phys::ZPP_Body(this->zpp_inner->inner->head->elt) : ::zpp_nape::phys::ZPP_Body(ite->next->elt) );
		HX_STACK_LINE(535)
...
::nape::phys::Body BodyList_obj::pop( ){
	HX_STACK_PUSH("BodyList::pop","nape/phys/BodyList.hx",478);
	HX_STACK_THIS(this);
	HX_STACK_LINE(480)
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(480)
	...
	if ((this->zpp_inner->reverse_flag)){
		...
		struct _Function_2_1{
			inline static int Block( ::nape::phys::BodyList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/phys/BodyList.hx",498);
				{
					HX_STACK_LINE(498)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(498)
...
bool BodyList_obj::unshift( ::nape::phys::Body obj){
	HX_STACK_PUSH("BodyList::unshift","nape/phys/BodyList.hx",447);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(449)
	if ((this->zpp_inner->immutable)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::phys::BodyList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/phys/BodyList.hx",458);
						{
							HX_STACK_LINE(458)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(458)
				...
				HX_STACK_LINE(458)
				this->zpp_inner->push_ite = (  (((this->zpp_inner->inner->head == null()))) ? ::zpp_nape::util::ZNPNode_ZPP_Body(null()) : ::zpp_nape::util::ZNPNode_ZPP_Body(this->zpp_inner->inner->iterator_at((_Function_4_1::Block(this) - (int)1))) );
			}
			HX_STACK_LINE(459)
...
bool BodyList_obj::push( ::nape::phys::Body obj){
	HX_STACK_PUSH("BodyList::push","nape/phys/BodyList.hx",416);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(418)
	if ((this->zpp_inner->immutable)){
	...
	if ((cont)){
		...
		if ((this->zpp_inner->reverse_flag)){
			...
			if (((this->zpp_inner->push_ite == null()))){
				struct _Function_4_1{
					inline static int Block( ::nape::phys::BodyList_obj *__this){
						HX_STACK_PUSH("*::closure","nape/phys/BodyList.hx",428);
						{
							HX_STACK_LINE(428)
							__this->zpp_inner->valmod();
							HX_STACK_LINE(428)
...
::nape::phys::Body BodyList_obj::at( int index){
	HX_STACK_PUSH("BodyList::at","nape/phys/BodyList.hx",363);
	HX_STACK_THIS(this);
	...
	struct _Function_1_1{
		inline static int Block( ::nape::phys::BodyList_obj *__this){
			HX_STACK_PUSH("*::closure","nape/phys/BodyList.hx",368);
			{
				HX_STACK_LINE(368)
				__this->zpp_inner->valmod();
				HX_STACK_LINE(368)
	...
	if ((this->zpp_inner->reverse_flag)){
		struct _Function_2_1{
			inline static int Block( ::nape::phys::BodyList_obj *__this){
				HX_STACK_PUSH("*::closure","nape/phys/BodyList.hx",370);
				{
					HX_STACK_LINE(370)
					__this->zpp_inner->valmod();
					HX_STACK_LINE(370)
...
bool BodyList_obj::has( ::nape::phys::Body obj){
	HX_STACK_PUSH("BodyList::has","nape/phys/BodyList.hx",346);
	HX_STACK_THIS(this);
	HX_STACK_ARG(obj,"obj");
	HX_STACK_LINE(347)
	this->zpp_inner->valmod();
...
int BodyList_obj::get_length( ){
	HX_STACK_PUSH("BodyList::get_length","nape/phys/BodyList.hx",244);
	HX_STACK_THIS(this);
	HX_STACK_LINE(245)
	this->zpp_inner->valmod();
	HX_STACK_LINE(246)
...
::nape::phys::BodyList BodyList_obj::fromArray( Array< ::nape::phys::Body > array){
	HX_STACK_PUSH("BodyList::fromArray","nape/phys/BodyList.hx",304);
	...
	HX_STACK_LINE(311)
	{
		...
		while(((_g < array->length))){
			HX_STACK_LINE(311)
			::nape::phys::Body i = array->__get(_g);		HX_STACK_VAR(i,"i");
			HX_STACK_LINE(311)
			++(_g);
			HX_STACK_LINE(316)
			ret->push(i);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("nape.phys.BodyList"), hx::TCanCast< BodyList_obj> ,sStaticFields,sMemberFields,
