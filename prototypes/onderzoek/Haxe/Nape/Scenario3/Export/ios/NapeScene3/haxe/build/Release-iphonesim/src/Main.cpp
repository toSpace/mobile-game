...
{
		HX_STACK_PUSH("Main::updateGraphics","Main.hx",217);
		HX_STACK_THIS(this);
		HX_STACK_ARG(b,"b");
		...
		struct _Function_1_2{
			inline static Float Block( ::nape::phys::Body &b){
				HX_STACK_PUSH("*::closure","Main.hx",221);
				{
...
{
		HX_STACK_PUSH("Main::enterFrameHandler","Main.hx",201);
		HX_STACK_THIS(this);
		HX_STACK_ARG(ev,"ev");
		HX_STACK_LINE(203)
		...
		HX_STACK_LINE(206)
		{
			...
			struct _Function_2_1{
				inline static ::nape::phys::BodyIterator Block( ::nape::phys::BodyList &_this){
					HX_STACK_PUSH("*::closure","Main.hx",206);
					{
						HX_STACK_LINE(206)
...
Dynamic Main_obj::getParticleType( ){
	HX_STACK_PUSH("Main::getParticleType","Main.hx",182);
	HX_STACK_THIS(this);
	HX_STACK_LINE(185)
	...
	HX_STACK_LINE(186)
	Array< Float > startPoints = Array_obj< Float >::__new().Add(0.1).Add(0.3).Add(0.5).Add(0.7).Add(0.9).Add(0.1).Add(0.3).Add(0.5);		HX_STACK_VAR(startPoints,"startPoints");
	HX_STACK_LINE(189)
...
{
		HX_STACK_PUSH("Main::addParticle","Main.hx",159);
		HX_STACK_THIS(this);
		HX_STACK_LINE(161)
