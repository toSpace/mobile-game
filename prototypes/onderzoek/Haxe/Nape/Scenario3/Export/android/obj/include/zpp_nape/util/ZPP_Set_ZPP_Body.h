...
class ZPP_Set_ZPP_Body_obj : public hx::Object{
	public:
	...
	public:
		...
		int colour; /* REM */ 
		::zpp_nape::util::ZPP_Set_ZPP_Body parent; /* REM */ 
		::zpp_nape::util::ZPP_Set_ZPP_Body next; /* REM */ 
		::zpp_nape::util::ZPP_Set_ZPP_Body prev; /* REM */ 
		::zpp_nape::phys::ZPP_Body data; /* REM */ 
		Dynamic swapped; /* REM */ 
		...
		static ::zpp_nape::util::ZPP_Set_ZPP_Body zpp_pool; /* REM */ 
};
