...
{
HX_STACK_PUSH("ZNPNode_ZPP_CutVert::new","zpp_nape/util/Lists.hx",15373);
{
	HX_STACK_LINE(15407)
	this->elt = null();
	HX_STACK_LINE(15398)
...
::zpp_nape::geom::ZPP_CutVert ZNPNode_ZPP_CutVert_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_CutVert::elem","zpp_nape/util/Lists.hx",15411);
	HX_STACK_THIS(this);
	HX_STACK_LINE(15411)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_CutVert::free","zpp_nape/util/Lists.hx",15404);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15404)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_CutVert::alloc","zpp_nape/util/Lists.hx",15401);
		HX_STACK_THIS(this);
	}
return null();
}
