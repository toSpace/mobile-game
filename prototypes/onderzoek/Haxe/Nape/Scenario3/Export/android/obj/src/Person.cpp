...
HX_STACK_PUSH("Person::new","Person.hx",25);
{
	...
	super::__construct();
	HX_STACK_LINE(29)
	::aze::display::SparrowTilesheet tilesheet = ::aze::display::SparrowTilesheet_obj::__new(::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/sprites/TP-file.png"),null()),::nme::installer::Assets_obj::getText(HX_CSTRING("assets/sprites/TP-file.xml")));		HX_STACK_VAR(tilesheet,"tilesheet");
	HX_STACK_LINE(32)
...
Float Person_obj::getHeight( ){
	HX_STACK_PUSH("Person::getHeight","Person.hx",66);
	HX_STACK_THIS(this);
	struct _Function_1_1{
		inline static Float Block( ::Person_obj *__this){
			HX_STACK_PUSH("*::closure","Person.hx",67);
			{
				HX_STACK_LINE(67)
...
Float Person_obj::getWidth( ){
	HX_STACK_PUSH("Person::getWidth","Person.hx",62);
	HX_STACK_THIS(this);
	struct _Function_1_1{
		inline static Float Block( ::Person_obj *__this){
			HX_STACK_PUSH("*::closure","Person.hx",63);
			{
				HX_STACK_LINE(63)
				::aze::display::TileClip _this = __this->clip;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(63)
...
::native::display::Sprite Person_obj::view( ){
	HX_STACK_PUSH("Person::view","Person.hx",58);
	HX_STACK_THIS(this);
	HX_STACK_LINE(58)
...
{
		HX_STACK_PUSH("Person::onEnterFrame","Person.hx",51);
		HX_STACK_THIS(this);
